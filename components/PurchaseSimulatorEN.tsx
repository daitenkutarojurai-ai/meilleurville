...
export function PurchaseSimulatorEN({ cities }: Props) {
  ...
  return (
    <div className="space-y-6">
      <Card>
        <h2 className="text-base font-semibold text-[var(--text-primary)] mb-4">Your parameters</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                aria-label="Total purchase budget"
                className="flex-1"
              />
              <input
                type="number"
                ...
                aria-label="Total purchase budget in euros"
                className="w-28 rounded-lg border border-[var(--border)] bg-[var(--bg-surface)] px-2 py-1 text-right font-mono-data font-bold"
              />
            </div>
            <p className="text-[10px] text-[var(--text-tertiary)] mt-1">€ — including notary fees</p>
          </div>
          ...
          <div>
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                aria-label="Target floor area in square metres"
                className="flex-1"
              />
              <input
                type="number"
            ...
            <p className="text-[10px] text-[var(--text-tertiary)] mt-1">m² floor area</p>
          </div>
          ...
          <div>
            ...
            <p className="text-[10px] text-[var(--text-tertiary)] mt-1">
              Down payment: {fmtEuro(downPayment)} · Loan: {fmtEuro(loanAmount)}
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-[10px] text-[var(--text-tertiary)] mt-1">
              Indicative rate {years === 20 ? RATE_20Y : RATE_25Y}% (excl. insurance)
            </p>
          </div>
        </div>
      </Card>
      ...
      <Card>
        ...
        <p className="text-[11px] text-[var(--text-tertiary)] mt-3">
          Rates: 3.6% over 20 years / 3.85% over 25 years (market average Jan 2026, excl.
          mortgage insurance ~0.3%/year). Notary fees for second-hand property estimated at
          7.5% of purchase price. Recommended down payment: ≥ 10-15% for the best rates.
        </p>
      </Card>

      <Card>
        <h2 className="text-base font-semibold text-[var(--text-primary)] mb-1">
          Top 15 affordable cities
        </h2>
        <p className="text-xs text-[var(--text-secondary)] mb-4">
          Cities where your budget of {fmtEuro(budget)} buys at least {surface} m².
          Ranked by quality of life.
        </p>
        {affordable.length === 0 ? (
          <p className="text-sm text-amber-700">
            No affordable city with this budget and surface area. Reduce the size or increase
            the budget.
          </p>
        ) : (
                    ...
                    <span className="flex items-baseline gap-2 min-w-0">
                      ...
                      <span className="min-w-0">
                        ...
                        <span className="text-[11px] text-[var(--text-tertiary)] truncate">
                          €{c.priceM2.toLocaleString("en-GB")}/m² · {fmtEuro(requiredBudget)} for {surface} m²
                        </span>
                      </span>
                    </span>
