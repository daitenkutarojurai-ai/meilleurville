    ...
    return (
      <button
        ...
        className={cn(
          ...
          {
            "bg-[var(--accent)] text-white hover:bg-[#4a6ee0] active:scale-[0.98] shadow-lg shadow-[var(--accent)]/20":
              variant === "primary",
            "bg-[var(--bg-elevated)] border border-[var(--border)] text-[var(--text-primary)] hover:bg-[#252836] hover:border-[#3a3f52]":
              variant === "secondary",
