...
function gradientForScore(score: number) {
  if (score >= 9.5) return "from-yellow-400 via-yellow-300 to-amber-200";
  if (score >= 7.5) return "from-emerald-500 via-emerald-400 to-green-400";
