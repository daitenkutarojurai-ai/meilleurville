...
**Phase 4 — long tail**
- [ ] EN guides — in progress (445 native EN guides via `data/guides-en.ts`; FR has 672; not 1:1 translations, native expat-angle content). 2026-06-03: **+10 native cost-of-living city guides** `cost-of-living-[city]-2026` (Paris/Lyon/Bordeaux/Toulouse/Montpellier/Nice/Nantes/Rennes/Strasbourg/Lille), grounded in the FR `budget-mensuel-realiste` figures + `housing.ts`, filling the EN budget gap (was 16 vs FR 134). Auto-registered via `EN_GUIDES`.
  - ⚠️ **Known bug (pre-existing, not yet fixed):** `data/guides-en.ts` has 3 DUPLICATE slugs — `strasbourg-living-guide-for-expats-2026` (L4411/4995), `rennes-living-guide-for-expats-2026` (L4447/5035), `french-school-system-expat-guide-2026` (L3979/9387). With `dynamicParams=false`, the 2nd of each pair is dead/shadowed content + a duplicate sitemap URL. Needs a keep-one / rename-one decision per pair.
- 2026-06-01/02:
