...
**Phase 4 — long tail**
- [ ] EN guides — in progress (357 native EN guides via `data/guides-en.ts`; FR has 673; not 1:1 translations, native expat-angle content). 2026-06-01/02:
  - 90 EN tourism guides `things-to-do-in-[city]-2026`, auto-surfaced as the featured card on `/cities/[slug]/things-to-do`. Slug + featured-card lookup mirror FR `a-faire` → `10-choses-a-faire`. Batch 1–5 (top 24 cities + Riviera/coast gems); batch 6 heritage+Riviera (Arles/Nîmes/Bayeux/Caen/Tours/Beaune/Sarlat/Saint-Tropez/Saint-Paul-de-Vence/Ajaccio); batch 7 Loire/Basque/Brittany (Amboise/Blois/Chinon/Saumur/Bayonne/Saint-Jean-de-Luz/Dinan/Vannes/Quimper/Gordes); batch 8 NE/Atlantic/Pyrenees/Corsica (Metz/Nancy/Le Havre/Arcachon/Collioure/Pau/Brest/Royan/Bastia/Calvi); batch 9 cathedrals/heritage (Albi/Cahors/Périgueux/Chartres/Amiens/Bourges/Orléans/Grasse/Sète/Narbonne); batch 10 Anjou/Pyrenees/Var/Savoie (Angers/Le Mans/Limoges/Angoulême/Lourdes/Hyères/Fréjus/Chambéry/Aix-les-Bains/Valence); batch 11 Franche-Comté/Auvergne/Charente/Picardy (Besançon/Le-Puy-en-Velay/Millau/Rodez/Saintes/Cognac/Bourg-en-Bresse/Vichy/Compiègne/Beauvais). Batches 6–8 live; 9–11 deploying. FR still has ~80 tourism guides without an EN equivalent.
