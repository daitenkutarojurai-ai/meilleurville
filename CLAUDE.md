...
French city ranking & relocation guide site. 540 cities, 465 FR guides + 224 EN guides, 19 ranking
...
**Phase 4 — long tail**
- [ ] EN guides — in progress (224 native EN guides shipped via `data/guides-en.ts`; not 1:1 translations, native expat-angle content)
