...
const SECTIONS = [
  {
    ...
    content: `Le responsable du traitement est Thomas Fendrich, entrepreneur individuel (SIREN 797 983 665), éditeur de MaVilleIdéale (mavilleideale.fr) et de BestCitiesInFrance (bestcitiesinfrance.com).
...
Le site n'emploie ni délégué à la protection des données (DPO), ni co-responsable de traitement — l'éditeur est seul décisionnaire.`,
  },
  {
    ...
    content: `Sur MaVilleIdéale, nous collectons strictement le minimum nécessaire :
...
Aucune donnée n'est utilisée pour de la publicité ciblée ou du profilage comportemental.`,
  },
  {
    ...
    content: `MaVilleIdéale utilise un minimum strict de cookies :
...
Booking.com peut déposer ses propres cookies si vous cliquez sur un lien partenaire et arrivez sur leur site — ces cookies relèvent alors de la politique de confidentialité de Booking.com, et non de la nôtre.`,
  },
  {
    ...
    content: `MaVilleIdéale participe au programme Booking.com Partners. Certains liens sortants vers Booking.com (boutons « Trouver un hôtel », barre flottante, fiches vacances) sont des liens partenaires.
