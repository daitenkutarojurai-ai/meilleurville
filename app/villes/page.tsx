...
export const metadata: Metadata = {
  ...
  description:
    "Découvrez les meilleures villes françaises : avis d'habitants, scores de qualité de vie, données locales. 232 communes analysées et comparées.",
};
    ...
    <main className="min-h-screen">
      ...
      <section className="bg-[var(--bg-surface)] py-14 border-b border-[var(--border)]">
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <Badge variant="accent" className="mb-3">232 villes</Badge>
