          ...
          <div
            ...
            <div className="lg:col-span-3">
              ...
              <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <a
                  href={`/villes/${city.slug}/teletravail`}
                  className="flex items-center justify-between rounded-xl border border-[var(--border)] bg-[var(--bg-surface)] hover:border-[var(--accent)]/40 hover:shadow-md transition-all px-5 py-4 group"
                >
                  <div className="min-w-0">
                    <div className="text-sm font-semibold text-[var(--text-primary)] group-hover:text-[var(--accent)] transition-colors">
                ...
                >
                  <div className="min-w-0">
                    ...
                    <div className="text-xs text-[var(--text-tertiary)] mt-0.5 truncate">
                      Médecins · spécialistes · urgences
                    </div>
                  </div>
                  <ChevronRight className="h-4 w-4 text-[var(--text-tertiary)] group-hover:text-[var(--accent)] transition-colors shrink-0" />
                </a>
                ...
                >
                  <div className="min-w-0">
                    ...
                    <div className="text-xs text-[var(--text-tertiary)] mt-0.5 truncate">
                      Quand y aller, quoi y faire, hôtels
                    </div>
                  </div>
                  <ChevronRight className="h-4 w-4 text-[var(--text-tertiary)] group-hover:text-[var(--accent)] transition-colors shrink-0" />
                </a>
                <a
                  href={`/villes/${city.slug}/s-installer`}
                  className="flex items-center justify-between rounded-xl border border-[var(--border)] bg-[var(--bg-surface)] hover:border-[var(--accent)]/40 hover:shadow-md transition-all px-5 py-4 group"
                >
                  <div className="min-w-0">
                    <div className="text-sm font-semibold text-[var(--text-primary)] group-hover:text-[var(--accent)] transition-colors">
                    ...
                    <div className="text-xs text-[var(--text-tertiary)] mt-0.5 truncate">
                      Logement, internet, démarches admin
                    </div>
                  </div>
                  <ChevronRight className="h-4 w-4 text-[var(--text-tertiary)] group-hover:text-[var(--accent)] transition-colors shrink-0" />
                </a>
                <a
                  href={`/villes/${city.slug}/connexion-internet`}
                  className="flex items-center justify-between rounded-xl border border-[var(--border)] bg-[var(--bg-surface)] hover:border-[var(--accent)]/40 hover:shadow-md transition-all px-5 py-4 group"
                >
                  <div className="min-w-0">
                    <div className="text-sm font-semibold text-[var(--text-primary)] group-hover:text-[var(--accent)] transition-colors">
                    ...
                    <div className="text-xs text-[var(--text-tertiary)] mt-0.5 truncate">
                      Fibre, débit, couverture
                    </div>
                  </div>
                  <ChevronRight className="h-4 w-4 text-[var(--text-tertiary)] group-hover:text-[var(--accent)] transition-colors shrink-0" />
                </a>
                <a
                  href={`/villes/${city.slug}/logement`}
                  className="flex items-center justify-between rounded-xl border border-[var(--border)] bg-[var(--bg-surface)] hover:border-[var(--accent)]/40 hover:shadow-md transition-all px-5 py-4 group"
                >
                  <div className="min-w-0">
                    <div className="text-sm font-semibold text-[var(--text-primary)] group-hover:text-[var(--accent)] transition-colors">
                    ...
                    <div className="text-xs text-[var(--text-tertiary)] mt-0.5 truncate">
                      Loyers, tension marché, quartiers
                    </div>
                  </div>
                  <ChevronRight className="h-4 w-4 text-[var(--text-tertiary)] group-hover:text-[var(--accent)] transition-colors shrink-0" />
                </a>
                <a
                  href={`/villes/${city.slug}/tension-locative`}
                  className="flex items-center justify-between rounded-xl border border-[var(--border)] bg-[var(--bg-surface)] hover:border-[var(--accent)]/40 hover:shadow-md transition-all px-5 py-4 group"
                >
                  <div className="min-w-0">
                    <div className="text-sm font-semibold text-[var(--text-primary)] group-hover:text-[var(--accent)] transition-colors">
                    ...
                    <div className="text-xs text-[var(--text-tertiary)] mt-0.5 truncate">
                      Délai, candidats/annonce, dossier requis
                    </div>
                  </div>
                  <ChevronRight className="h-4 w-4 text-[var(--text-tertiary)] group-hover:text-[var(--accent)] transition-colors shrink-0" />
                </a>
                ...
                >
                  <div className="min-w-0">
                    ...
                    <div className="text-xs text-[var(--text-tertiary)] mt-0.5 truncate">
                      Expats, retraités, étudiants, télétravail
                    </div>
                  </div>
                  <ChevronRight className="h-4 w-4 text-[var(--text-tertiary)] group-hover:text-[var(--accent)] transition-colors shrink-0" />
                </a>
                <a
                  href={`/villes/${city.slug}/questions`}
                  className="flex items-center justify-between rounded-xl border border-[var(--border)] bg-[var(--bg-surface)] hover:border-[var(--accent)]/40 hover:shadow-md transition-all px-5 py-4 group"
                >
                  <div className="min-w-0">
                    <div className="text-sm font-semibold text-[var(--text-primary)] group-hover:text-[var(--accent)] transition-colors">
                    ...
                    <div className="text-xs text-[var(--text-tertiary)] mt-0.5 truncate">
                      13 réponses chiffrées 2026
                    </div>
                  </div>
                  <ChevronRight className="h-4 w-4 text-[var(--text-tertiary)] group-hover:text-[var(--accent)] transition-colors shrink-0" />
                </a>
                <a
                  href={`/villes/${city.slug}/agenda`}
                  className="flex items-center justify-between rounded-xl border border-[var(--border)] bg-[var(--bg-surface)] hover:border-[var(--accent)]/40 hover:shadow-md transition-all px-5 py-4 group"
                >
                  <div className="min-w-0">
                    <div className="text-sm font-semibold text-[var(--text-primary)] group-hover:text-[var(--accent)] transition-colors">
                    ...
                    <div className="text-xs text-[var(--text-tertiary)] mt-0.5 truncate">
                      Festivals, marchés, saisons 2026
                    </div>
                  </div>
                  <ChevronRight className="h-4 w-4 text-[var(--text-tertiary)] group-hover:text-[var(--accent)] transition-colors shrink-0" />
                </a>
                <a
                  href={`/villes/${city.slug}/mentalite-locale`}
                  className="flex items-center justify-between rounded-xl border border-[var(--border)] bg-[var(--bg-surface)] hover:border-[var(--accent)]/40 hover:shadow-md transition-all px-5 py-4 group"
                >
                  <div className="min-w-0">
                    <div className="text-sm font-semibold text-[var(--text-primary)] group-hover:text-[var(--accent)] transition-colors">
                    ...
                    <div className="text-xs text-[var(--text-tertiary)] mt-0.5 truncate">
                      Tempo, ouverture, café, archetype régional
                    </div>
                  </div>
                  <ChevronRight className="h-4 w-4 text-[var(--text-tertiary)] group-hover:text-[var(--accent)] transition-colors shrink-0" />
                </a>
