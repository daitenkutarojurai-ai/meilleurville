        ...
        <div className="mt-3 grid grid-cols-2 sm:grid-cols-3 gap-3">
          ...
          <Link href="/pour-qui/navetteurs-hybrides" className="block">
            <Card className="hover:shadow-md transition-shadow h-full">
              <div className="text-2xl mb-1">🚆</div>
              <div className="text-sm font-semibold text-[var(--text-primary)]">
                Habiter loin, revenir deux jours
              </div>
              <div className="text-xs text-[var(--text-tertiary)] mt-1">
                En hybride, le bassin d&apos;emploi qui compte n&apos;est plus le local :
                c&apos;est le temps de trajet vers le plus proche des douze grands pôles,
                estimé et croisé avec le loyer
              </div>
            </Card>
          </Link>
