...
export const alt = "Explore every French city | BestCitiesInFrance";
...
export default function Image() {
  const top6 = [...CITIES_SEED].sort((a, b) => b.scores.global - a.scores.global).slice(0, 6);
      ...
      >
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          ...
          <div style={{ background: "#161b22", border: "1px solid #30363d", borderRadius: "8px", padding: "6px 14px", color: "#8b949e", fontSize: "14px" }}>
            {CITIES_SEED.length} cities
          </div>
        </div>

        <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
          <div style={{ color: "#8b949e", fontSize: "16px", letterSpacing: "2px", textTransform: "uppercase" }}>Profiles & scores</div>
          <div style={{ color: "#f0f6fc", fontSize: "60px", fontWeight: 900, lineHeight: 1 }}>Every French city</div>
          <div style={{ color: "#8b949e", fontSize: "18px" }}>Quality of life · Climate · Cost · Safety · Schools · 8 axes of data</div>
        </div>
          ...
          {top6.map((city) => {
            ...
            return (
              ...
              >
                ...
                <span style={{ color, fontSize: "22px", fontWeight: 900 }}>{city.scores.global.toFixed(1)}</span>
              </div>
            );
          })}
        </div>
