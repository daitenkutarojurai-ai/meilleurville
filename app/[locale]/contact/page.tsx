    ...
    <main id="main-content" className="min-h-screen">
      ...
      <section className="mx-auto max-w-3xl px-4 sm:px-6 pt-20 pb-16">
        ...
        <p className="text-lg text-[var(--text-secondary)] leading-relaxed mb-8">
          Feedback on a ranking, a data correction, a partnership, or just a question about a French city? Pick a topic, tell us what you need, and we will get back to you.
        </p>
