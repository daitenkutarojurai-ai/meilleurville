...
export const alt = "Lifestyle quiz — find your French city profile | BestCitiesInFrance";
    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          ...
          <div style={{ color: "#f0f6fc", fontSize: "62px", fontWeight: 900, lineHeight: 1.05, maxWidth: "800px" }}>
            Map your priorities to the right city
          </div>
          <div style={{ color: "#8b949e", fontSize: "22px", maxWidth: "640px" }}>
            {`${CITIES_COUNT} cities ranked against your personal profile`}
          </div>
        </div>

        <div style={{ display: "flex", gap: "10px" }}>
          {["🏖️ Sun", "💰 Budget", "🔒 Safety", "🌿 Nature", "🚲 Mobility", "👨‍👩‍👧 Family"].map((tag) => (
            <div
              key={tag}
              style={{
                background: "#161b22",
