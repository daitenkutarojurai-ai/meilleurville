  ...
  return (
    <main id="main-content" className="min-h-screen">
      ...
      <section className="mx-auto max-w-3xl px-4 sm:px-6 pt-20 pb-16">
        ...
        <p className="text-[var(--text-secondary)] leading-relaxed mb-6">
          BestCitiesInFrance is the English version of <a className="text-[var(--accent)] hover:underline" href="https://www.mavilleideale.fr">MaVilleIdéale</a> (mavilleideale.fr). Same data, written for English-speaking readers.
        </p>
