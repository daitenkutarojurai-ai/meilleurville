...
export const alt = "Real cost of living calculator for French cities 2026 | BestCitiesInFrance";
      ...
      >
        ...
        <div style={{ display: "flex", gap: "40px", alignItems: "flex-start" }}>
          <div style={{ display: "flex", flexDirection: "column", gap: "8px", flex: 1 }}>
            <div style={{ color: "#8b949e", fontSize: "16px", letterSpacing: "2px", textTransform: "uppercase" }}>Beyond just the rent</div>
            <div style={{ color: "#f0f6fc", fontSize: "50px", fontWeight: 900, lineHeight: 1 }}>Real cost of living calculator</div>
            <div style={{ color: "#8b949e", fontSize: "17px" }}>Total monthly budget — rent, energy, transport, food, and more by city</div>
          </div>
