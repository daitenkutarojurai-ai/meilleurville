...
export const alt = "Public services rankings by French city | BestCitiesInFrance";
export const size = { width: 1200, height: 630 };
export const contentType = "image/png";

const METRICS = [
  { emoji: "🏫", label: "Schools" },
  { emoji: "📮", label: "Post & admin" },
  { emoji: "🏛️", label: "Town hall access" },
  { emoji: "📚", label: "Libraries" },
  { emoji: "🏊", label: "Pools & sports" },
  { emoji: "🌳", label: "Parks & green" },
];
    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
          <div style={{ color: "#8b949e", fontSize: "16px", letterSpacing: "2px", textTransform: "uppercase" }}>BPE · INSEE data</div>
          <div style={{ color: "#f0f6fc", fontSize: "52px", fontWeight: 900, lineHeight: 1 }}>Public services ranking</div>
          <div style={{ color: "#8b949e", fontSize: "18px" }}>Schools · transport · admin · green space across {CITIES_COUNT} French cities</div>
        </div>
