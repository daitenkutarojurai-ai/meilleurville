...
const SECTIONS = [
  {
    ...
    content: `The data controller is Thomas Fendrich, sole trader (SIREN 797 983 665), publisher of BestCitiesInFrance (bestcitiesinfrance.com) and MaVilleIdéale (mavilleideale.fr).
