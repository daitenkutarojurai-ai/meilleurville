...
export const alt = "Top French cities ranked by quality of life — BestCitiesInFrance";
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
          ...
          <div style={{ color: "#f0f6fc", fontSize: "60px", fontWeight: 900, lineHeight: 1 }}>
            {`Top ${top10.length} cities`}
          </div>
          <div style={{ color: "#8b949e", fontSize: "17px" }}>
            {`Composite score across 9 criteria · ${CITIES_SEED.length} cities analysed`}
          </div>
        </div>
