...
const TEAM = [
  ...
  },
  {
    ...
    description: "La qualité de MaVilleIdéale dépend de la communauté. Nous avons construit des systèmes anti-manipulation et de vérification pour que chaque avis compte.",
    emoji: "🤝",
  },
];
  ...
  return (
    <main id="main-content" className="min-h-screen">
      ...
      <section className="bg-[var(--bg-surface)] border-b border-[var(--border)] py-16">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 text-center">
          ...
          <p className="text-[var(--text-secondary)] text-lg leading-relaxed">
            ...
            MaVilleIdéale est le Glassdoor des villes : des données réelles, des avis honnêtes,
      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 py-16 space-y-20">
        ...
        {/* Origin story */}
        <div>
          <h2 className="text-2xl font-bold text-[var(--text-primary)] mb-6">Pourquoi MaVilleIdéale existe</h2>
          <div className="space-y-4 text-[var(--text-secondary)] leading-relaxed">
            ...
            <p>
              MaVilleIdéale ne vend pas de publicité pour les villes. Ne reçoit pas d&apos;argent des offices de tourisme.
