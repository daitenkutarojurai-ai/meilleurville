...
// Keep in sync with SITEMAP_CHUNKS in app/sitemap.ts (FR: 14 chunks incl.
// comparer-regions + calculator + gentrification + quitter; EN: 3).
const CHUNK_COUNT = DEFAULT_LOCALE === "en" ? 3 : 14;
