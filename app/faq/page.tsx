  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        a: "La carte interactive (/carte) affiche les 226 villes analysées avec un code couleur selon leur score (vert = excellent, ambre = bon, rouge = à améliorer). Vous pouvez filtrer l'affichage par critère (nature, transport, coût...) et cliquer sur chaque ville pour accéder à son profil. La taille du cercle est proportionnelle au score.",
      },
    ],
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        a: "Les guides sont classés par catégorie : Télétravail, Famille, Budget & Coût, Style de vie, Par région, et Comparaisons. Chaque guide est lié aux profils des villes qu'il mentionne, aux classements thématiques correspondants, et à d'autres guides connexes. Accédez à l'ensemble des 88 guides sur /guides.",
      },
      {
