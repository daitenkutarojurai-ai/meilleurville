...
export const EXPAT_COUNTRIES: ExpatCountryProfile[] = [
  ...
  },
  {
    ...
    bestSuitedCities: ["paris", "marseille", "bordeaux", "nantes", "lyon", "aix-en-provence", "montpellier", "toulouse", "nice"],
    intro:
      "Le retour de Côte d'Ivoire — première communauté française d'Afrique subsaharienne, largement concentrée à Abidjan (Cocody, Riviera, Marcory, Plateau) et à San Pedro — cumule trois particularités qui structurent la préparation : une parité fixe du XOF avec l'euro (655,957 XOF pour 1 €, mécanisme franc CFA hérité de 1948 et confirmé par la BCEAO, ce qui supprime tout risque de change mais complique parfois les transferts au-delà des plafonds bancaires), un saut de pouvoir d'achat à l'inverse de la plupart des retours d'expatriation (on quitte un coût de la vie hors quartiers résidentiels premium sensiblement plus bas — loyers, employés de maison, alimentaire local, services — pour retrouver une France beaucoup plus chère surtout côté logement et main-d'œuvre) et un système fiscal ivoirien à part (IUTS — Impôt Unique sur les Traitements et Salaires — progressif jusqu'à 32 %, prélevé à la source par l'employeur, avec des abattements familiaux et un plafond mensuel exonéré de 75 000 XOF). Côté fiscal, la convention bilatérale FR-CI de 1966 (avenants 1985 et 1993) évite la double imposition ; côté retraite, la convention de sécurité sociale FR-CI de 1985 (entrée en vigueur en 1987) permet, cas notable en Afrique, la totalisation des trimestres cotisés à la CNPS (Caisse nationale de prévoyance sociale, secteur privé) ou à la CGRAE (Caisse générale de retraite des agents de l'État) avec ceux de l'Assurance retraite française. Côté ancrage géographique, les Français rentrant d'Abidjan visent souvent Paris (Air France quotidien direct Paris-Abidjan, écosystème corporate franco-ivoirien concentré sur les sièges Bolloré Logistics, Bouygues, CFAO, Orange, TotalEnergies, BNP Paribas, Société Générale, Compagnie Fruitière), Marseille (armateurs Compagnie Ivoirienne de Transport Maritime et CMA CGM, communauté franco-africaine dense, ferries et cargo réguliers), Bordeaux (BNP Paribas Afrique, CFAO Motors, écosystème du négoce cacao), Nantes (histoire atlantique du commerce Afrique de l'Ouest, écoles internationales), Lyon (bureaux régionaux Total, Bolloré, écoles internationales Cité scolaire internationale), Aix-en-Provence, Montpellier, Toulouse et Nice pour un compromis entre climat, communauté franco-africaine et infrastructures internationales.",
    hadVsWillHave: [
      { topic: "Salaire net", had: "700 000-2 500 000 XOF net/mois cadre (Abidjan Plateau, secteur banque, tech, télécoms, BTP, mines, agri-industrie)", willHave: "Équivalent ~2 200-3 800 € net en France après charges (cadre métropole, fiscalité comprise)" },
      { topic: "Loyer T3", had: "250 000-600 000 XOF (Cocody Riviera, Deux-Plateaux, Marcory, Plateau — quartiers résidentiels cadres expat)", willHave: "650-1 300 € (Marseille, Montpellier, Toulouse, Nantes), 1 700-2 700 € (Paris)" },
      { topic: "Panier alimentaire", had: "Environ 30-45 % moins cher sur les produits locaux (marchés de Cocody, Adjamé, Treichville) mais 40-80 % plus cher sur l'import (Prosuma, Casino Abidjan, Carrefour Market)", willHave: "Reprise du niveau français (Lidl, Carrefour, marchés), fruits et légumes de saison sensiblement plus variés" },
      { topic: "Santé", had: "Clinique privée (PISAM, Farah, Hôtel-Dieu de Cocody) à charge de l'employeur ou assurance IPMI (April International, Cigna, Allianz Worldwide Care), consultations 15 000-40 000 XOF, hôpital public sous-équipé pour les cas complexes", willHave: "Sécu + mutuelle 80-200 €/mois, accès médecin traitant et hôpital public bien équipé sans reste à charge structurel équivalent" },
      { topic: "Fiscalité revenu", had: "IUTS (Impôt Unique sur les Traitements et Salaires) progressif jusqu'à 32 %, retenue à la source par l'employeur, CN-PS 6,3 % salarié + 7,7 % employeur, CMU 1 000 XOF/mois", willHave: "~25-35 % effectif (TMI + CSG 9,7 % + prélèvements sociaux 17,2 % sur revenus du capital)" },
      { topic: "Garde d'enfants", had: "Nounou à domicile (aide-maman) 60 000-150 000 XOF/mois temps plein, école française André Malraux ou Blaise Pascal (AEFE, Abidjan) 1,8-4,5 M XOF/an selon niveau", willHave: "Crèche FR 150-400 €/mois après CAF/CMG, maternelle publique gratuite dès 3 ans, école internationale ~6 000-18 000 €/an si maintien" },
      { topic: "Voiture", had: "Essence super ~715 XOF/L, gasoil ~615 XOF/L (prix homologué), 4x4 ou pick-up quasi indispensable en saison des pluies, embouteillages Plateau-Cocody 45-90 min", willHave: "Carburant 1,65-1,95 €/L, péages autoroutiers fréquents, alternatives TER/TGV/métro dans toutes les métropoles" },
      { topic: "Personnel de maison", had: "Cuisinier, jardinier, veilleur, aide-maman couramment employés (100 000-250 000 XOF/mois chacun selon expérience et logement fourni)", willHave: "Coût équivalent multiplié par 4-6 en France, employés à temps plein rarissimes hors familles à très haut revenu — retour souvent vécu comme une perte de confort domestique majeure" },
    ],
    adminPriorities: [
      { step: "Déclarer le retour au consulat & radier", detail: "Avant le départ : se radier du registre des Français établis hors de France auprès du consulat général de France à Abidjan (Plateau) et conserver l'attestation de radiation, utile pour la CAF, la CPAM et les démarches scolaires. À anticiper 4-6 semaines avant le vol — le consulat traite un volume important en fin d'année scolaire (juin-août).", officialUrl: "https://www.service-public.gouv.fr/particuliers/vosdroits/R43251" },
      { step: "Clôture des comptes locaux & transferts XOF→EUR", detail: "Le franc CFA XOF est convertible à taux fixe (655,957 XOF pour 1 €) mais les banques ivoiriennes (SGCI, BICICI, NSIA, Ecobank, Orabank, BOA) appliquent des plafonds de transferts vers l'étranger et exigent souvent un justificatif de résidence fiscale future (contrat de travail français, promesse d'embauche, quittance de loyer FR) au-delà de 5 à 10 M XOF cumulés par an. Anticipez : la clôture d'un compte peut prendre 4-8 semaines, et le solde de tout compte de fin de contrat CNPS (indemnité de départ, congés payés capitalisés, participation) est versé sous 30-60 jours après démission. Résilier abonnements Orange, MTN, Moov Africa, Canal+ Afrique au moins 30 jours avant le départ pour éviter les prélèvements automatiques post-retour." },
      { step: "CNPS/CGRAE : totalisation des trimestres retraite", detail: "Grâce à la convention de sécurité sociale FR-CI de 1985 (en vigueur depuis 1987), les trimestres cotisés à la CNPS (secteur privé) ou à la CGRAE (secteur public ivoirien) sont totalisés avec ceux de l'Assurance retraite française pour le calcul du taux plein. Concrètement, un cadre ayant travaillé 8 ans en Côte d'Ivoire puis 30 ans en France valide 38 ans côté français (avec paiement partiel ivoirien à 55-60 ans selon la caisse). Demander à la CNPS d'Abidjan (siège Plateau ou agence de Cocody) un relevé de carrière détaillé avant le départ — pièce indispensable au moment de la liquidation de la retraite française, souvent 20-40 ans plus tard. Conserver bulletins de paie, certificat de travail et attestation employeur." },
      { step: "Sécurité sociale (CPAM & assurance transitoire)", detail: "Pas de formulaire S1 (la Côte d'Ivoire n'est pas dans l'UE). La convention bilatérale de 1985 couvre les pensions de vieillesse et l'invalidité, pas l'assurance maladie courante. Ouvrir un dossier CPAM dès l'arrivée avec un justificatif de résidence et la fin d'affiliation à la CNAM-CI (CMU) ou à l'assurance santé privée employeur (IPMI April, Cigna, Allianz Worldwide Care). Prévoir une assurance privée temporaire pour combler le délai d'instruction (3-6 semaines). L'affiliation à la Caisse des Français de l'étranger (CFE) pendant le séjour ivoirien reste utile pour valider les trimestres retraite côté français en complément de la CNPS.", officialUrl: "https://www.service-public.gouv.fr/particuliers/vosdroits/F32824" },
      { step: "Fiscalité revenu (IUTS & convention 1966)", detail: "Convention fiscale FR-CI (1966, avenants 1985 et 1993) : résidence fiscale française à compter du jour J. Déclaration fractionnée l'année du retour côté français (formulaire 2042 + 2047 pour les revenus de source ivoirienne post-retour) + dernière déclaration IUTS auprès de la DGI ivoirienne (Direction Générale des Impôts, Plateau) pour la période travaillée avant le départ — l'IUTS est prélevé à la source par l'employeur, mais une régularisation annuelle peut être due si vous aviez plusieurs employeurs, des revenus fonciers ivoiriens ou des bénéfices non commerciaux (BNC pour indépendants). Pour les binationaux ayant conservé une activité, un compte-titre ou un bien locatif en Côte d'Ivoire, les revenus restent imposables selon la convention avec crédit d'impôt français." },
      { step: "Permis de conduire", detail: "Le permis ivoirien (délivré par l'ANDE — Agence Nationale de la Direction des Ordonnateurs de l'État, ou anciennement OSER) est échangeable contre un permis français dans les 12 mois suivant le retour grâce à l'accord de réciprocité FR-CI (arrêté du 12 janvier 2012). Au-delà des 12 mois, il faut repasser le code et la conduite. Démarche en ligne via l'ANTS, sur présentation du titre ivoirien, d'une traduction assermentée en français si le titre n'est pas déjà bilingue, et du relevé d'information de conduite. Attention : les permis délivrés avant l'accord de 2012 sont parfois refusés — vérifier avec la préfecture avant démarche." },
    ],
    warnings: [
      "Convention de sécurité sociale FR-CI 1985 : cas rare en Afrique subsaharienne, les trimestres cotisés à la CNPS (secteur privé) ou à la CGRAE (secteur public) sont totalisables avec l'Assurance retraite française. Conservez impérativement tous vos relevés de carrière CNPS, certificats de travail, bulletins de paie et attestations employeur — ils vous seront demandés à 62-67 ans, souvent 20-40 ans après le départ. Sans ces pièces, la totalisation devient un parcours du combattant et certaines années peuvent rester des zéros dans le relevé de carrière français.",
      "Franc CFA (XOF) : parité fixe à 655,957 XOF pour 1 € garantie par le Trésor français dans le cadre de la Zone franc UEMOA, ce qui supprime tout risque de change instantané. En revanche, les banques ivoiriennes appliquent des plafonds de transferts vers l'étranger et exigent un justificatif de résidence fiscale future au-delà de 5-10 M XOF cumulés par an. Anticipez le rapatriement en plusieurs tranches et privilégiez les services spécialisés (Wise, Wero) plutôt que les virements bancaires classiques qui appliquent des frais de 1-3 % + spread.",
      "Fiscalité IUTS et régularisation de départ : l'IUTS ivoirien est prélevé à la source par l'employeur (progressif jusqu'à 32 %), mais l'année de départ nécessite une régularisation auprès de la DGI si vous aviez plusieurs employeurs, des revenus fonciers, des dividendes de participations locales ou des BNC. Le certificat de quitus fiscal (attestation de non-redevance) est utile en cas de retour temporaire ou de contrôle post-départ — à demander à la DGI avant le vol.",
      "Statut binational ou double résidence : la fiscalité française récupère les revenus mondiaux à compter du jour J, y compris les dividendes ou loyers ivoiriens et les gains sur les comptes-titres ouverts en Côte d'Ivoire. Pour les retours partiels (foyer fiscal en France, activité maintenue à Abidjan en télétravail ou en tant qu'administrateur non-résident), la qualification de résidence fiscale est complexe — un avis fiscal franco-ivoirien est indispensable, surtout si votre employeur ne propose pas de bascule vers une entité française ou européenne.",
      "Indemnité de fin de contrat CNPS et solde de tout compte : ne signez jamais la lettre de démission sans une timeline claire de versement de l'indemnité de départ (congés payés capitalisés, gratification de fin d'année, participation, éventuelle prime de licenciement selon la convention collective). Une fois le visa ou la carte consulaire annulé, la pression légale côté ivoirien diminue nettement. Prévoir 30-60 jours de délai standard.",
      "Scolarité française à l'étranger : si vos enfants étaient au lycée français Blaise Pascal (Cocody), à l'école André Malraux (Riviera) ou dans le réseau AEFE ivoirien (Bouaké, San Pedro), le retour vers le système public ou privé français se fait sans démarche d'équivalence (mêmes programmes, mêmes bulletins, mêmes options). Inscription en mairie suffit pour le primaire, le collège et le lycée. Pour les enfants scolarisés en écoles internationales anglophones (International Community School of Abidjan, ICSA) ou ivoiriennes, l'entretien d'équivalence avec l'établissement français cible est indispensable.",
      "Climat : le contraste peut être marqué pour qui rentre d'Abidjan (climat équatorial de mousson, 25-32 °C toute l'année, humidité 75-90 %, saison sèche décembre-avril, harmattan janvier-février). Privilégier Marseille, Montpellier, Nice, Aix-en-Provence, Toulouse ou Bordeaux plutôt qu'une métropole du Nord ou de l'Est pour adoucir la transition, surtout la première année — un cadre habitué à la chaleur ivoirienne trouvera un hiver à Lille, Strasbourg ou Reims particulièrement éprouvant les six premiers mois.",
      "Logement français en zone tendue : si vous ciblez Paris, Nice, Lyon ou Bordeaux, anticipez 2-3 mois pour décrocher un T3 avec dossier d'expat (employeur ivoirien sortant, pas de fiches de paie FR récentes). Prévoir un garant Visale ou un employeur français déjà signé avant l'arrivée, et conserver vos relevés bancaires ivoiriens (SGCI, BICICI, NSIA, Ecobank) et attestations CNPS pour justifier le revenu d'épargne. Les agences françaises acceptent difficilement les IPMI comme preuve d'assurance santé — activer la CPAM en priorité aide.",
      "Perte du confort domestique : la France ne reproduit pas le standard de vie ivoirien pour un cadre expatrié (villa avec jardin à Cocody, personnel de maison temps plein, gardien de nuit). Un cadre gagnant 1,8 M XOF net à Abidjan (~2 750 €) ne retrouve pas son standard de vie en rentrant à 3 200 € net à Lyon ou Bordeaux : le loyer récupère la différence, l'employé de maison disparaît, la voiture devient plus contrainte (ZFE, ronds-points, radars). Anticipez un maintien à 60-75 % de votre standard de vie ivoirien, pas une amélioration mécanique due au salaire brut supérieur.",
    ],
  },
  {
  ...
  },
  {
    ...
    bestSuitedCities: ["strasbourg", "rennes", "nantes", "grenoble", "lyon", "bordeaux", "lille", "toulouse", "montpellier", "paris"],
    intro:
      "Le retour de Suède est le seul de ce guide où le choc fiscal n'existe pas. La réputation d'impôts confiscatoires ne résiste pas au calcul : pour un cadre au salaire ordinaire, la ponction suédoise — kommunalskatt à taux plat, environ 29 à 35 % selon la commune de résidence, impôt d'État de 20 % seulement au-delà d'un seuil situé autour de 600 000 à 625 000 SEK bruts annuels selon l'année, le tout allégé par le jobbskatteavdrag — tombe dans la même fourchette effective que le couple impôt sur le revenu plus CSG côté français. Les cotisations patronales suédoises (arbetsgivaravgifter, 31,42 %) sont payées au-dessus du brut et n'apparaissent jamais sur le bulletin, ce qui donne l'illusion d'un net généreux ; l'illusion se dissipe des deux côtés de la frontière. Le vrai choc est ailleurs, et il joue dans les deux sens. Favorable d'abord, sur le logement : en Suède, un contrat de première main (förstahandskontrakt) s'obtient par file d'attente municipale, et à Stockholm cette file dépasse couramment neuf à onze ans pour le centre, ce qui condamne la plupart des arrivants à la sous-location (andrahand), chère et précaire. Rentrer en France, c'est retrouver un marché où un T3 se loue sur dossier en quelques semaines. Défavorable ensuite, et c'est le point que les familles sous-estiment : on quitte le régime de garde et de congé parental le plus généreux d'Europe — 480 jours de congé partagés par enfant, plafond maxtaxa autour de 1 700 SEK par mois pour la crèche, déjeuner scolaire gratuit de la maternelle au lycée — pour un système français où la crèche revient à 150-400 € par mois après CAF et CMG et où le congé parental indemnisé (PreParE) tourne autour de 450 € mensuels. Reste un angle mort patrimonial que presque personne n'anticipe : la Suède n'a plus d'impôt sur la fortune depuis 2007 ni de droits de succession et de donation depuis 2004-2005. Rentrer, c'est réintégrer l'IFI et la fiscalité successorale française du jour au lendemain. Côté ancrage géographique, les Français qui rentrent de Stockholm, Göteborg, Malmö, Uppsala ou Lund visent le plus souvent des métropoles dont le modèle urbain ressemble à ce qu'ils quittent : Strasbourg et Grenoble pour le vélo quotidien, le tram et la ville compacte ; Rennes et Nantes pour la taille intermédiaire et l'écosystème tech ; Lyon et Bordeaux pour les bascules corporate ; Lille pour la continuité climatique et la proximité de l'axe nord-européen ; Toulouse et Montpellier pour la lumière ; Paris pour les profils finance, siège et recherche.",
    hadVsWillHave: [
      { topic: "Salaire net", had: "32 000-55 000 SEK net/mois cadre (tech, ingénierie, sciences de la vie — Stockholm, Göteborg, Malmö, Lund, hors bonus)", willHave: "Équivalent ~2 800-4 500 € net en France après charges (cadre métropole) : l'écart de fiscalité est faible, l'écart vient surtout du change" },
      { topic: "Loyer T3", had: "8 000-12 000 SEK en première main (förstahandskontrakt, loyer négocié collectivement — mais file d'attente de 9-11 ans à Stockholm centre), 18 000-28 000 SEK en sous-location andrahand, la voie réelle pour un arrivant", willHave: "1 020-1 380 € (Grenoble, Strasbourg, Lille, Rennes, Nantes, Toulouse, Bordeaux, Lyon), 2 800 € (Paris) — accessible sur dossier en quelques semaines" },
      { topic: "Achat", had: "Bostadsrätt : vous n'achetez pas le lot mais une part de l'association de copropriétaires (bostadsrättsförening) avec droit d'usage, plus une avgift mensuelle qui suit l'endettement de l'association. Intérêts d'emprunt déductibles à 30 % jusqu'à 100 000 SEK, amortissement obligatoire (amorteringskrav) selon la quotité", willHave: "Pleine propriété du lot en copropriété, charges séparées du prêt. 3 200 €/m² (Grenoble), 3 500 (Lille), 3 800 (Strasbourg, Rennes), 4 200 (Nantes), 4 500 (Bordeaux), 5 000 (Lyon), 10 500 (Paris). Aucune déduction des intérêts sur la résidence principale" },
      { topic: "Fiscalité revenu", had: "Kommunalskatt à taux plat ~29-35 % selon la commune + 20 % d'impôt d'État au-delà d'environ 600 000-625 000 SEK bruts, moins le jobbskatteavdrag, soit ~25-35 % effectif", willHave: "~25-35 % effectif (TMI + CSG 9,7 % + prélèvements sociaux 17,2 % sur les revenus du capital). Le retour est à peu près neutre sur ce poste — c'est l'exception de ce guide" },
      { topic: "Patrimoine & succession", had: "Pas d'impôt sur la fortune (supprimé en 2007), pas de droits de succession ni de donation (supprimés en 2004-2005). Épargne logée en ISK ou kapitalförsäkring, forfaitairement et très légèrement taxée", willHave: "IFI au-delà de 1,3 M€ de patrimoine immobilier net, droits de succession et de donation au barème français, PFU 30 % sur les revenus et plus-values de placement — l'enveloppe ISK n'est pas reconnue et son contenu redevient taxable au régime ordinaire" },
      { topic: "Santé", had: "Système régional financé par l'impôt : patientavgift de ~200-300 SEK par consultation, plafonnée par le högkostnadsskydd (autour de 1 400 SEK/an de soins et 2 900 SEK/an de médicaments), garantie de délais vårdgaranti 0-3-90-90 souvent tenue pour le premier contact, beaucoup moins pour les spécialistes", willHave: "Sécu + mutuelle 80-200 €/mois, tiers payant, accès direct plus rapide au spécialiste, densité de généralistes très inégale selon la commune" },
      { topic: "Garde d'enfants & congé parental", had: "Förskola plafonnée par la maxtaxa à ~3 % du revenu du foyer et environ 1 700 SEK/mois pour le premier enfant, gratuite à temps partiel dès 3 ans ; 480 jours de congé parental par enfant dont 390 à ~80 % du salaire (plafonné) et 90 jours réservés à chaque parent ; barnbidrag universel d'environ 1 250 SEK/mois par enfant", willHave: "Crèche 150-400 €/mois après CAF et CMG, maternelle publique gratuite dès 3 ans, allocations familiales à partir du deuxième enfant seulement, PreParE autour de 450 €/mois. C'est la vraie perte du retour pour un foyer avec enfants en bas âge" },
      { topic: "École", had: "Grundskola 9 ans puis gymnasium 3 ans, gratuits, déjeuner scolaire inclus du premier au dernier jour ; notation à partir de la 6e année ; Lycée français Saint Louis de Stockholm pour la continuité AEFE", willHave: "École publique gratuite mais cantine payante (2-6 €/repas selon le quotient familial), programme français plus dense en mathématiques et en français écrit dans les petites classes — prévoir un décalage à combler si l'enfant vient du système suédois" },
      { topic: "Panier alimentaire & alcool", had: "Alimentaire ~10-20 % plus cher qu'en France (ICA, Coop, Willys, Lidl) ; alcool vendu uniquement par le monopole d'État Systembolaget, fortement taxé ; dagens lunch à 110-145 SEK, le meilleur rapport qualité-prix du pays", willHave: "Reprise du niveau français, produits frais et vin nettement plus abordables, restauration du midi plus chère qu'un dagens lunch suédois" },
      { topic: "Voiture & transport", had: "Carburant ~17-20 SEK/L, trängselskatt (péage urbain) à Stockholm et Göteborg, pneus hiver obligatoires du 1er décembre au 31 mars en conditions hivernales, réseau SJ correct mais cher hors réservation anticipée", willHave: "Carburant 1,65-1,95 €/L, pas de péage urbain mais péages autoroutiers fréquents, pas d'obligation nationale de pneus hiver hors zones montagne (loi Montagne), réseau TER/TGV plus dense" },
    ],
    adminPriorities: [
      { step: "Déclarer le retour au consulat & radier", detail: "Avant le départ : se radier du registre des Français établis hors de France auprès de la section consulaire de l'ambassade de France en Suède (Stockholm) et conserver l'attestation de radiation, utile pour la CAF, la CPAM et les inscriptions scolaires. À anticiper 4-6 semaines avant le déménagement.", officialUrl: "https://www.service-public.gouv.fr/particuliers/vosdroits/R43251" },
      { step: "Anmäl flytt utomlands auprès de Skatteverket", detail: "Déclarer le départ définitif au fisc suédois (flytt utomlands) pour sortir du folkbokföring, le registre de population qui commande à peu près tout en Suède : imposition, accès aux soins, allocations, courrier officiel. Sans cette déclaration vous restez officiellement domicilié en Suède et continuez d'y être imposé sur le revenu mondial. Le personnummer, lui, reste valide à vie : conservez-le, il vous servira pour toutes les régularisations ultérieures (déclaration finale, retraite, remboursements). Prévoir aussi la résiliation des abonnements liés au personnummer (Telia, Tele2, Telenor, assurances, BankID) — le BankID cesse de fonctionner dès que l'adresse suédoise disparaît, ce qui bloque l'accès aux portails en ligne : téléchargez tous vos justificatifs avant." },
      { step: "Sécurité sociale : formulaire S1", detail: "La Suède est dans l'UE, donc le règlement européen 883/2004 s'applique : demander le formulaire S1 à la Försäkringskassan avant le départ et le transmettre à la CPAM du nouveau domicile. Compter 3-6 semaines d'instruction côté français. Aucune convention bilatérale à invoquer, aucune assurance privée relais à souscrire dans la plupart des cas — la carte européenne d'assurance maladie couvre l'intervalle. Signaler également le départ à la Försäkringskassan pour arrêter proprement barnbidrag et éventuelles indemnités en cours, sous peine de trop-perçus réclamés ensuite.", officialUrl: "https://www.service-public.gouv.fr/particuliers/vosdroits/F32824" },
      { step: "Fiscalité revenu : déclaration finale et règle des cinq ans", detail: "Convention fiscale franco-suédoise de 1990 : résidence fiscale française à compter du jour J, déclaration fractionnée l'année du retour côté français (formulaires 2042 et 2047 pour les revenus de source suédoise postérieurs au retour). Côté suédois, l'inkomstdeklaration de l'année du départ reste due au printemps suivant. Point critique : la règle de väsentlig anknytning (liens essentiels) fait présumer, pendant cinq ans après le départ, que vous restez résident fiscal suédois si vous conservez certains liens — logement disponible en Suède, y compris une sommarstuga utilisable à l'année, famille proche restée sur place, participation significative dans une société suédoise. Pendant ces cinq ans, la charge de la preuve pèse sur vous, pas sur l'administration." },
      { step: "Retraite : Pensionsmyndigheten et tjänstepension", detail: "Deux mécanismes distincts, à traiter séparément. (1) La retraite publique (inkomstpension et premiepension) relève de la coordination européenne : les périodes cotisées en Suède sont totalisées avec celles de l'Assurance retraite française, rien ne se perd, mais tenez à jour votre adresse auprès de Pensionsmyndigheten et conservez tous les orange kuvert annuels. (2) La retraite complémentaire d'entreprise (tjänstepension, versée via Alecta, AMF, Folksam, Skandia selon la convention collective ITP, SAF-LO ou du secteur public) n'entre pas dans cette coordination : elle reste gérée par l'organisme suédois et se liquide à partir de 55-65 ans selon le contrat, où que vous résidiez. Elle représente souvent 20 à 30 % de la pension totale d'un cadre suédois — une adresse périmée chez l'assureur suffit à la rendre introuvable dix ans plus tard." },
      { step: "Permis de conduire & scolarité", detail: "Le permis suédois est un permis de l'Union européenne : il reste valide de plein droit en France, aucun échange obligatoire (demande utile seulement en cas de perte, de vol ou d'expiration). Pour les enfants, inscription en mairie pour le primaire et auprès du rectorat pour le secondaire. Si l'enfant venait du Lycée français Saint Louis de Stockholm (réseau AEFE), le retour se fait sans démarche d'équivalence — mêmes programmes, mêmes bulletins. S'il sortait de la grundskola ou du gymnasium suédois, un entretien d'équivalence avec l'établissement cible est indispensable : la scolarité obligatoire suédoise démarre à 6 ans en förskoleklass, la notation n'intervient qu'en 6e année, et le décalage se voit surtout en mathématiques et en français écrit." },
    ],
    warnings: [
      "Väsentlig anknytning, le piège de la maison de campagne : pendant cinq ans après le départ, la Suède présume que vous êtes resté résident fiscal si vous gardez des liens essentiels sur place — et la sommarstuga familiale, si elle est utilisable à l'année et à votre disposition, en fait typiquement partie. La charge de la preuve vous incombe pendant toute cette période. Concrètement, un couple qui rentre à Rennes tout en gardant une maison d'été en Dalécarlie peut se voir réclamer l'impôt suédois sur ses revenus mondiaux. Faites trancher la question par un conseil fiscal suédois avant le départ, pas après le premier redressement, et documentez la rupture des liens (vente ou mise en location longue durée, radiation du folkbokföring, résidence effective en France).",
      "L'enveloppe ISK ne survit pas au passage de la frontière : l'Investeringssparkonto et la kapitalförsäkring sont des régimes forfaitaires suédois extrêmement légers, sans équivalent français et non reconnus par l'administration fiscale française. Une fois résident en France, les titres qu'ils contiennent redeviennent taxables au régime ordinaire (PFU de 30 %, prélèvements sociaux inclus) sur les revenus et les plus-values. S'ajoute une obligation déclarative souvent oubliée : tout compte financier détenu à l'étranger doit être déclaré chaque année (formulaire 3916), sous peine d'une amende forfaitaire par compte non déclaré. Arbitrez avec un fiscaliste avant le retour — solder l'enveloppe côté suédois, la conserver, ou étaler les cessions ne donne pas le même résultat.",
      "Vente du bostadsrätt : la plus-value sur un logement privé est imposée à environ 22 % effectif en Suède, avec un mécanisme de report (uppskov) qui suppose le rachat d'un logement de remplacement dans l'Espace économique européen. La France en fait partie, donc le report est en principe mobilisable pour un achat français — mais l'articulation avec la fiscalité française de la résidence principale demande une validation des deux côtés. Rappelez-vous aussi que vous ne vendez pas un lot mais une part d'association : le prix dépend de la dette portée par la bostadsrättsförening, information à sortir de l'årsredovisning avant de fixer votre prix.",
      "Le retour coûte cher aux jeunes parents, pas aux contribuables : c'est l'inversion typique de ce dossier. Un foyer sans enfant retrouve à peu près son pouvoir d'achat, hors effet de change. Un foyer avec un enfant de moins de trois ans perd le plafond maxtaxa (environ 1 700 SEK par mois de crèche), le déjeuner scolaire gratuit, le barnbidrag universel, et surtout les 480 jours de congé parental dont 390 indemnisés autour de 80 % du salaire — le PreParE français tourne autour de 450 € mensuels. Si un deuxième enfant est au programme, la question n'est pas anecdotique : le calendrier familial se décide avant le déménagement, pas après.",
      "Patrimoine : vous rentrez dans deux impôts que la Suède ne connaît plus. L'impôt sur la fortune y a été supprimé en 2007, les droits de succession et de donation en 2004-2005. Une famille installée à Stockholm depuis quinze ans a pu transmettre, donner et capitaliser sans jamais rencontrer ces sujets. Le retour réactive l'IFI au-delà de 1,3 M€ de patrimoine immobilier net et la fiscalité successorale française sur l'ensemble du patrimoine mondial dès lors que le défunt ou l'héritier est résident. Les donations et les schémas de transmission préparés sous droit suédois ne se transposent pas mécaniquement — un notaire français doit relire l'existant.",
      "Choc de change, pas choc fiscal : la couronne suédoise s'est nettement affaiblie face à l'euro depuis 2021, autour de 11,3-11,7 SEK pour 1 € début 2026 contre environ 10,1-10,3 il y a cinq ans. Une épargne de 800 000 SEK vaut aujourd'hui près de 70 000 € contre environ 78 000 € au taux de 2021. Ne calculez pas votre budget français sur un taux mémorisé, et lissez le rapatriement sur plusieurs tranches (6 à 12 mois) plutôt qu'en un seul virement, surtout si vous financez un apport immobilier.",
      "La lumière, à l'envers des autres retours : contrairement à ceux qui rentrent de Singapour ou de Dubaï, vous ne fuyez pas la chaleur, vous quittez un déficit d'éclairement hivernal. Stockholm tombe sous six heures de jour au solstice de décembre, avec un lever vers 8 h 45 et un coucher vers 14 h 50 ; n'importe quelle ville française vous rendra deux à trois heures de jour en plein hiver. L'inverse est vrai l'été : les soirées scandinaves interminables de juin n'existent nulle part en France, et c'est la perte que les rentrants signalent le plus souvent la première année. Inutile, donc, de choisir votre ville française uniquement pour le soleil — l'écart hivernal entre Lille et Montpellier est réel mais bien plus faible que celui que vous venez de gagner.",
      "Logement français en zone tendue : si vous ciblez Bordeaux, Lyon, Rennes ou Paris, anticipez deux à trois mois pour décrocher un T3 avec un dossier d'expat (employeur suédois sortant, aucune fiche de paie française récente). Prévoir un garant Visale ou un contrat de travail français déjà signé avant l'arrivée, et conserver vos relevés bancaires suédois (SEB, Swedbank, Handelsbanken, Nordea) pour justifier de l'épargne. Attention au calendrier : la perte du BankID au moment de la radiation vous coupe de la quasi-totalité des portails suédois — sortez tous vos justificatifs de revenus, avis d'imposition et relevés annuels avant, pas après.",
      "Déménagement et animaux : conteneur maritime ou groupage routier Stockholm/Göteborg→France 3 000-6 000 € selon le volume, 2 à 4 semaines par la route (le transport routier via le Danemark et l'Allemagne reste plus rapide et souvent moins cher que le maritime sur cette distance). Vols Stockholm-Paris 100-350 € par personne selon la saison. Pour les animaux, circulation intra-UE simple : puce ISO, passeport européen pour animal de compagnie et vaccination antirabique valide suffisent, sans titrage sérologique ni quarantaine — c'est l'un des rares retours de ce guide où l'animal ne coûte presque rien. La voiture suédoise se rapatrie sans difficulté (conduite à droite depuis 1967, homologation UE), mais pensez à la radier auprès de Transportstyrelsen et à faire immatriculer en France dans le mois suivant l'arrivée.",
    ],
  },
];
