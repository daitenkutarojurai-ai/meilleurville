...
export const EN_GUIDES: EnGuide[] = [
  ...
  {
    slug: "biarritz-basque-coast-expat-guide-2026",
    title: "Living in Biarritz & the Basque Coast as an Expat (2026)",
    metaTitle: "Biarritz Basque Coast 2026 — expat guide: surf, cost of living, neighbourhoods, year-round",
    metaDesc: "Honest expat guide to Biarritz, Anglet, Saint-Jean-de-Luz, Bayonne in 2026: surf culture, real cost of living, neighbourhoods, Basque identity, year-round life.",
    category: "city-guide",
    emoji: "🌊",
    readMinutes: 11,
    publishedAt: "2026-05-25",
    updatedAt: "2026-05-25",
    intro: "The French Basque coast — Biarritz, Anglet, Bayonne, Saint-Jean-de-Luz — has become one of France's most desirable expat destinations: world-class surf, Atlantic climate that is milder than the Mediterranean in summer and warmer than Brittany in winter, distinctive Basque culture, three airports within an hour (Biarritz, San Sebastián, Bilbao), and proximity to both the Pyrenees and Spain. The catch: property prices have nearly doubled in a decade, the summer is genuinely overrun, and the local culture is more particular than guidebooks suggest. Here is what year-round Basque coast living actually looks like in 2026.",
    sections: [
      {
        heading: "The cities of the Basque coast and what each is",
        body: "**Biarritz** (25,000 residents, 100,000+ in summer): the famous one. Imperial heritage (Napoléon III made it fashionable), Belle Époque mansions, prestigious surf and golf culture. Expensive, glamorous, slightly performative. **Anglet** (40,000): Biarritz's working neighbour to the north, much more residential and family-oriented. Owns the surf beaches that Biarritz markets. Genuinely lived-in. **Bayonne** (52,000): the old city, the Basque cultural capital, half-timbered medieval streets, ham (jambon de Bayonne) and chocolate heritage. 15 minutes inland — cooler in summer, less tourist pressure. **Saint-Jean-de-Luz** (14,000): smaller, more refined, deep Basque tradition, beautiful bay, fishing port, Louis XIV's wedding site (1660). Heavily affluent, especially Parisians and Spaniards. **Hendaye** (17,000): on the Spanish border, less polished, more affordable, mixed French-Spanish population. The whole stretch is referred to as the BAB (Bayonne-Anglet-Biarritz) urban area; an expat thinking of the 'Basque coast' is choosing among these five towns.",
      },
      {
        heading: "Cost of living: high and rising",
        body: "Property prices have nearly doubled since 2014. **Biarritz**: €7,000-12,000/m² for ancien, €8,000-14,000 for neuf or seafront. **Anglet**: €5,500-8,000/m². **Bayonne**: €4,000-6,500/m² (the affordable inland option). **Saint-Jean-de-Luz**: €7,500-12,000/m². **Hendaye**: €4,000-6,000/m². Rentals (year-round leases, not seasonal): T2 furnished in Biarritz €900-1,400/month, Anglet €750-1,100/month, Bayonne €600-850/month. The seasonal rental market dwarfs the year-round market — finding a 12-month furnished rental is significantly harder than in Lyon or Nantes, and prices for year-round have risen because of Airbnb pressure. Groceries: 10-15% above national average. Restaurants: tourist pricing on the coast (€20-30 menu lunch), Bayonne is meaningfully cheaper.",
      },
      {
        heading: "The Basque identity and what it means in daily life",
        body: "The French Basque country (Pays Basque français, or Iparralde in Basque) is small — three traditional provinces, ~300,000 residents — but the Basque identity is real and visible. The Basque language (Euskara) is spoken by perhaps 50,000 people, taught in immersion schools (ikastolas), present on most street signs. The cultural calendar is dense: fêtes de Bayonne (5 days of red-and-white celebration in late July, 1.2 million attendees), pelote basque played on courts in every village, jambon de Bayonne IGP, axoa stew, gâteau basque, txakoli wine. As an expat, you do not have to learn Basque to live here, but understanding that you are not just 'in southern France' helps the integration significantly. The Basques are direct, not particularly demonstrative, and immensely loyal to the region — once you genuinely belong, you belong.",
      },
      {
        heading: "Climate and the seasonal rhythm",
        body: "Climate: oceanic, mild. Average July max ~25°C, January max ~13°C. Annual rainfall 1,400-1,500 mm (high — among the wettest in France, equal to Brittany). Summer: warm and pleasant, rarely above 32°C, sea temperature 20-23°C peak. Winter: rarely below 5°C, but persistently grey and rainy from November to February. Spring and autumn are exceptional — mild, sunny, manageable crowds. The seasonal rhythm: July-August is overrun (population multiplies by 4-5x in Biarritz/Saint-Jean-de-Luz), traffic and parking are extreme. September-November is paradise (warm, empty beaches, full restaurants but reasonable). December-February is genuinely quiet (some restaurants close, the surf scene continues, the Basque culture is more accessible). March-May is the best time to visit before committing.",
      },
      {
        heading: "Surf, sports and outdoor culture",
        body: "The surf culture is genuine — Biarritz held the first European surf competitions in 1957, and the region produces consistent surfers at world level. Best surf spots: Côte des Basques (Biarritz, beginner-intermediate), Grande Plage (Biarritz, all levels), Anglet beaches (Anglet, varied), La Barre (Anglet), Lafitenia (Saint-Jean-de-Luz, advanced). Multiple surf schools accept long-term locals, with annual rates around €600-1,200/year for unlimited lessons or club membership. Other sports: pelote basque clubs are open to non-Basques; golf (Biarritz Le Phare, Chiberta Anglet, Chantaco Saint-Jean-de-Luz are among the most prestigious in France); hiking (Pyrenees foothills 20-40 min inland, the GR10 traverses the region); cycling and road biking on the coastal roads. Skiing: La Pierre-Saint-Martin and Gourette are 90-120 min by car — small Pyrenean stations.",
      },
      {
        heading: "Schools, healthcare, and the practical infrastructure",
        body: "**Schools**: public schools are decent; the main international option is the LISA (Lycée International de la Soule à Atharratze), some 90 min inland, French Baccalauréat International. Bilingual French-Basque immersion schools (Ikastola) and French-Spanish/French-English public sections exist in Bayonne and Biarritz. For genuinely international schooling, Bordeaux (2h) is the nearest serious option. **Healthcare**: Centre Hospitalier de la Côte Basque (Bayonne) is the main hospital — competent for general care, specialised cases sometimes referred to Bordeaux. GP access has become difficult in 2024-2025 — register with a GP as soon as you arrive. **Airports**: Biarritz-Pays Basque (10 min from city centre) — limited international, mainly easyJet/Air France to Paris, London, Amsterdam, Geneva. San Sebastián airport (30 min by car, in Spain) — Spanish domestic and some international. Bilbao airport (90 min) — major international airport, the practical international gateway.",
      },
      {
        heading: "Who the Basque coast works for and who it doesn't",
        body: "Works best for: surfers and outdoor-sports-focused expats, families with the budget to handle high property prices, retirees who value coastal life with cultural depth, remote workers with stable high incomes, Parisians escaping the capital who want lifestyle without sacrificing cosmopolitanism. Less ideal for: budget-constrained expats (you will struggle here — Pau, Bayonne back-country, or Tarbes are dramatically more affordable for the same Pyrenean access), career-focused under-40s in non-remote roles (local job market is thin outside hospitality and surf industry), those allergic to summer tourist density (July-August is intense), and anyone seeking dry sunny Mediterranean weather (the Basque coast is wet enough that it surprises Mediterranean expats moving here). For property buyers: avoid the seafront premium unless you are committed long-term; year-round residents typically live 200-500m inland and have better value.",
      },
    ],
    relatedCities: ["biarritz", "anglet", "bayonne", "saint-jean-de-luz"],
    tags: ["biarritz expat 2026", "basque coast expat guide", "living in biarritz year round", "bayonne anglet expat", "surf france expat basque"],
  },
  {
    slug: "mortgage-france-foreigner-expat-guide-2026",
    title: "Getting a Mortgage in France as a Foreigner (2026)",
    metaTitle: "France Mortgage for Foreigners 2026 — non-resident, expat, rates, banks, dossier guide",
    metaDesc: "How to get a mortgage in France as a foreigner in 2026: non-resident vs resident, banks, rates, dossier, LTV, broker, taxes, the complete process.",
    category: "moving",
    emoji: "🏦",
    readMinutes: 12,
    publishedAt: "2026-05-25",
    updatedAt: "2026-05-25",
    intro: "France is one of the most mortgage-friendly countries in Europe for foreign buyers — long fixed-rate loans (15-25 years standard), low rates by global standards, and clear legal protection of borrowers. But the path from foreign passport to signed mortgage involves a paperwork density that surprises Anglo-American buyers, plus a few critical distinctions (resident vs non-resident, EU vs non-EU, employed vs self-employed) that determine how much you can borrow and on what terms. Here is the complete picture in 2026, covering both expat-resident buyers and non-resident foreign investors.",
    sections: [
      {
        heading: "Resident vs non-resident: the fundamental split",
        body: "**Resident foreigner** (you have a French tax residency, work or live in France, and have a French bank account): you are treated essentially like a French citizen by mortgage lenders. You can borrow up to 80-90% of property value (LTV — loan-to-value ratio), with loan terms of 15-25 years, on similar rates to French nationals. EU residents have full access; non-EU residents with a valid residence permit also have access at most banks (some banks impose minimum 5-year residence or French tax history). **Non-resident foreigner** (you live abroad, may have only seasonal use of the property): much stricter terms. Maximum LTV is typically 60-70% (so you need a 30-40% cash deposit), loan terms typically capped at 15-20 years, rates are slightly higher (0.3-0.6 percentage points above resident rates), and many banks simply will not lend to non-residents. The market for non-resident mortgages is specialised — a handful of banks (BNP Paribas International, HSBC France, Crédit Agricole International, Banque Populaire) have dedicated international/expat mortgage desks.",
      },
      {
        heading: "Mortgage rates and types in 2026",
        body: "French mortgages are overwhelmingly **fixed-rate for the full term** — this is the norm, not the exception. 20-year fixed mortgages in 2026 are running approximately 3.4-4.2% APR for residents with strong dossiers, and 3.8-4.7% for non-residents. 25-year mortgages add 0.2-0.4 percentage points. Variable-rate mortgages exist but are uncommon (5% of new originations) — borrowers in France strongly prefer rate certainty. **Insurance (assurance emprunteur)** is mandatory and significant: typically 0.2-0.6% per year of the borrowed capital, adding €20-150/month depending on age, health, and amount. Since 2022 (Loi Lemoine), borrowers can switch insurance providers at any time during the loan — most save €5,000-25,000 over the life of the loan by switching from the bank's in-house insurance to an external provider after closing. **Early repayment**: French mortgages allow early repayment but a fee of up to 3% of the remaining principal applies (Article L312-21 du Code de la consommation). Many loans negotiated with brokers waive this fee. **No prepayment penalty** for sale of the property due to job relocation or death.",
      },
      {
        heading: "How much you can borrow: the 35% rule",
        body: "France's banking supervisor (HCSF) imposed in 2021 a strict rule: total household debt service (mortgage + insurance + other loan repayments) cannot exceed 35% of total monthly income (taux d'endettement). This is a hard cap, not a guideline. The rule was tightened in 2022 (it was 33% before, now 35% including insurance). What this means in practice: a household with €5,000/month net income can have maximum €1,750/month total mortgage payment. At 4% over 25 years, this corresponds to a maximum borrowable amount of approximately €330,000. **Foreign-income haircuts**: banks discount foreign income that fluctuates with exchange rates — typically by 20-30%. If you earn $80,000 in the US, a French bank may treat this as €56,000 (instead of the spot conversion ~€72,000), reducing your borrowing capacity. Solution: maintain a stable French income for 6-12 months before applying, or work with a broker who specialises in foreign-income borrowers.",
      },
      {
        heading: "The dossier: what banks want",
        body: "Document checklist for a mortgage application: **identity**: passport, French residence permit if applicable. **address**: French utility bill or lease if resident, current proof of address if non-resident. **income**: last 3 years of tax returns (in original language plus French translation if non-French), last 6 months of payslips, employment contract (CDI strongly preferred — see CDD/freelance section below), 3 months of bank statements showing salary deposits. **assets and savings**: 3-6 months of all bank accounts, brokerage account statements, retirement account values. **debt**: list of all outstanding loans (mortgages, car loans, student loans, credit-card balances). **property**: the compromis de vente (preliminary sale agreement signed with the seller), the survey/expertise of the property, the syndic documents if a flat in a building. **CDD or self-employed**: 2-3 years of tax history, accountant-certified income statements, demonstration of business continuity. Banks pull every loose thread — gaps in employment or unexplained large transfers raise red flags.",
      },
      {
        heading: "Using a broker (courtier en crédit immobilier)",
        body: "French mortgage brokers (courtiers) are widely used — 35-40% of new mortgages in 2026 are placed via brokers. They consult multiple banks on your behalf, find better rates than you typically can directly, handle the paperwork, and resolve issues with the dossier. **Cost**: traditional brokers charge approximately 1% of the loan amount (€2,500-4,500 typical) — paid at closing, sometimes added to the mortgage. Some online brokers (Pretto, Cafpi, Empruntis) charge €0 — they earn from bank commissions instead. For foreign buyers, a broker is highly recommended: they know which banks accept foreign income, which have the best rates for your specific profile, and can negotiate insurance separately. **Choosing a broker**: prefer brokers experienced with non-resident or foreign-income clients. Verify their ORIAS registration (mandatory for French financial intermediaries) on orias.fr. Avoid pressure brokers who push specific banks; the best brokers present 3-5 options side-by-side.",
      },
      {
        heading: "Timeline and the buying process",
        body: "1. **Pre-approval (accord de principe)**: typically 1-3 weeks from when you submit a complete dossier. Banks issue a 'simulation' of what you can borrow. This is informal but useful. 2. **Property search**: typically 2-12 weeks. 3. **Signed offer (compromis de vente)**: when you and the seller agree on terms, you sign a compromis (preliminary sale contract) at the notaire's office. This triggers your 10-day cooling-off period. 4. **Formal mortgage application**: you submit the compromis to your bank/broker. The bank typically takes 4-6 weeks to issue the formal mortgage offer (offre de prêt). 5. **Cooling-off period for the mortgage**: by law (Loi Scrivener), you have 10 days after receiving the formal mortgage offer before you can accept it. You must wait. 6. **Acceptance**: you sign and return the formal offer. 7. **Acte authentique**: the final notarial deed, typically 4-8 weeks after the compromis. You sign the deed, the funds are released, you receive the keys. **Total timeline**: typically 3-4 months from offer accepted to keys in hand, slower for non-residents. Buyers from abroad often delegate signing to a French representative via a procuration (power of attorney) — fully legal and routine.",
      },
      {
        heading: "Costs beyond the mortgage",
        body: "Beyond the loan, plan for: **Frais de notaire** (notary fees, taxes, administrative costs) — approximately **7-8% of the purchase price for older properties (ancien)**, **2-3% for new-build (neuf)**. This is the largest non-mortgage cost. **Frais d'agence** (estate agent fees) — typically 4-7% of the purchase price, paid either by buyer or seller depending on the listing. Check whose budget includes it. **Mortgage fees**: dossier fee €700-1,500, mortgage guarantee fees (1.0-1.5% of the loan, partially refundable at end of loan via Crédit Logement system), insurance setup. **Property survey (diagnostic immobilier)** — typically paid by seller but you can commission an additional independent survey for €350-800. **Annual ongoing costs**: taxe foncière (€800-3,000+ depending on property value and commune), taxe d'habitation residence secondaire if applicable (additional tax in zone tendue communes for non-primary residences), home insurance (€20-80/month), syndic charges for apartments (€100-400/month for a flat).",
      },
    ],
    relatedCities: ["paris", "lyon", "bordeaux", "marseille", "nice"],
    tags: ["mortgage france foreigner 2026", "french mortgage expat guide", "non resident mortgage france", "buying property france mortgage", "france mortgage rates 2026"],
  },
  {
    slug: "bringing-car-to-france-immatriculation-expat-guide-2026",
    title: "Bringing Your Car to France: Import & Registration Guide (2026)",
    metaTitle: "Importing Car to France 2026 — immatriculation, customs, EU and non-EU, expat guide",
    metaDesc: "How to bring your car to France in 2026: EU vs non-EU imports, customs, TVA, technical inspection, immatriculation, costs, timeline.",
    category: "moving",
    emoji: "🚗",
    readMinutes: 11,
    publishedAt: "2026-05-25",
    updatedAt: "2026-05-25",
    intro: "If you are moving to France and want to bring your car with you, the process is feasible but bureaucratic. For EU expats, it is moderately straightforward. For non-EU expats from the US, UK (post-Brexit), Canada, or further afield, the process includes customs clearance, potential VAT and duties, and a French homologation procedure for vehicles not built to EU standards. Many expats decide it is cheaper and easier to sell the car at origin and buy a French-registered vehicle on arrival. This guide walks through both decisions and how to actually do the import if you proceed.",
    sections: [
      {
        heading: "Should you import your car at all?",
        body: "Quick decision framework. **Cases where importing makes sense**: high-end European car already in EU specifications (Mercedes, BMW, Audi, etc., from outside France but built for EU market) — minimal modification required; uncommon vehicles unavailable or expensive in France; sentimental value (your father's restored '67 Mustang); company-owned vehicle requiring identical replacement. **Cases where importing doesn't make sense**: standard mass-market car readily available in France; vehicle in non-EU specs (US/UK/Australian/Japanese spec) — homologation can cost €1,500-6,000+ and headlights/speedometer/emissions may need replacement; vehicle older than 10 years (transport cost + import duty + registration may exceed market value); right-hand drive (UK/Ireland) — legal in France but practically inconvenient and lowers resale value 30-40%. **Decision shortcut**: get a quote for shipping + total import costs + French homologation; compare to the cost of a similar French-registered car. For most US/Asian/Australian vehicles, selling at origin and buying in France is significantly cheaper.",
      },
      {
        heading: "EU imports: the straightforward case",
        body: "Bringing a car from another EU country (or Norway, Iceland, Switzerland with a treaty) is relatively simple. **Customs**: none — EU single market. **VAT**: not due if the vehicle is more than 6 months old AND has more than 6,000 km on the odometer. Otherwise (essentially a new car), 20% VAT is payable in France minus VAT already paid at origin. **Documents needed**: original registration certificate (carte grise / V5C / Fahrzeugbrief), proof of purchase, valid CT (contrôle technique) less than 6 months old or French CT done before registration, certificate of conformity COC (Certificat de Conformité Européen — your manufacturer provides this, sometimes free, sometimes €100-300; required for the French registration). **Process**: 1) Get an attestation of car de-registration from the country of origin (usually automatic when you submit a sale/transfer document). 2) Bring car to France. 3) Apply for French registration online via ants.gouv.fr (Agence Nationale des Titres Sécurisés). 4) Pay the carte grise tax (€300-2,000+ depending on power and emissions). 5) Receive the carte grise within 2-6 weeks; receive the metal plates immediately at any official immatriculateur. **Timeline**: 4-12 weeks total. **Cost**: €300-2,500 plus shipping if applicable.",
      },
      {
        heading: "Non-EU imports: the complex case",
        body: "Bringing a car from the US, UK (post-Brexit), Canada, Australia, Japan, or any non-EU country: **Customs**: duty is 10% of the vehicle's customs value (often the purchase price plus shipping) for vehicles not in 'déménagement définitif' status. If you qualify for déménagement définitif (moving your principal residence to France, vehicle owned and used by you for 6+ months prior, you owned the vehicle outside the EU for 12+ months), then customs duty is waived. **VAT**: 20% of the customs value, due unless you qualify for déménagement définitif exemption. **Homologation** (the big one): non-EU vehicles must be 'homologated' to EU specs. This may include: replacing headlights (US sealed beams must be replaced with EU adaptive units), replacing speedometer if in mph only, replacing turn signals (US amber rear lights must become EU red+amber separated), modifying emissions equipment, replacing exhaust if non-compliant, modifying side mirrors. Homologation through an approved centre (DREAL, France) costs €1,500-3,500 for typical vehicles, up to €6,000+ for vehicles requiring extensive modification. **Process**: 1) Ship vehicle to a French port (Le Havre is most common). 2) Pay customs at port. 3) Pay VAT (if applicable). 4) Apply for réception à titre isolé (RTI) — individual approval — through DREAL. 5) Vehicle is modified and inspected. 6) Get French homologation certificate. 7) Apply for carte grise on ants.gouv.fr. **Timeline**: 4-8 months. **Total cost**: shipping €1,500-3,500 + customs + VAT + homologation €1,500-3,500 + registration. For a typical American sedan: $5,000-15,000+ all-in.",
      },
      {
        heading: "The déménagement définitif customs exemption",
        body: "If you are establishing your principal residence in France for the first time from outside the EU, you can claim the **déménagement définitif** exemption for personal effects including one (or sometimes two) personal vehicles. Conditions: 1) The vehicle must have been **owned and used by you for at least 6 months** before the move. 2) You must have lived outside the EU for at least 12 months prior. 3) The vehicle arrives within 12 months of your move. 4) The vehicle is for personal use only (no resale for at least 12 months). 5) You provide documentation: residence permit, proof of new French address, vehicle registration in your name showing 6+ months ownership, certificate of de-registration from the country of origin. **Result**: customs duty and VAT are waived. This is significant — it can save €4,000-€20,000+ depending on vehicle value. **However**: you still must do the homologation (RTI) procedure, which costs the same regardless of the customs exemption.",
      },
      {
        heading: "The carte grise: French registration in detail",
        body: "Since 2017, all French vehicle registrations go through the **ANTS (Agence Nationale des Titres Sécurisés)** online platform — ants.gouv.fr. You can no longer register at the prefecture. **Application**: online with your account; upload all documents (carte grise origine, COC, CT, proof of address, ID, customs documents if applicable, homologation if applicable). **Tax (taxe régionale)**: based on the vehicle's fiscal power (chevaux fiscaux, CV) and emissions. For a typical mid-size sedan: €300-1,200. For a high-power car or significant emissions: €1,500-3,500+. The CO2 malus (penalty tax) on high-emissions vehicles has tightened dramatically; a 250 g CO2/km car incurs a malus of up to €60,000+ in 2026. New imports of high-CO2 used cars (over 200 g/km) face significant costs. **Processing**: 2-8 weeks. **Plates**: provided by any approved plate-maker (€20-40 per set) once you have the carte grise number. **Insurance**: mandatory from day 1 of French ownership. You cannot drive a French-registered car without French insurance. Switch insurance to French provider before driving on the new plates.",
      },
      {
        heading: "Driving licence transfer",
        body: "Parallel to vehicle registration, your driving licence must be sorted. **EU/EEA licences**: valid indefinitely in France with no exchange required. Optional exchange to a French licence card for convenience. **UK, Swiss, Norwegian licences**: pre-Brexit UK licences and Swiss/Norwegian licences are recognised; UK licences issued after January 2021 have specific bilateral arrangement. **Non-EU licences (US, Canada, Australia, etc.)**: you may drive with your foreign licence + an international driving permit for 1 year from arrival. After that, you must exchange to a French licence. Exchange agreements are reciprocal and vary by country/state. The US has reciprocity with about 22 states (Massachusetts, Pennsylvania, Texas, New York, Virginia, etc.); some US states do not have reciprocity and you must pass the full French driving test (theory + practice). Check the Service Public site for the latest list. **Exchange process**: online via ants.gouv.fr, submit licence + ID + proof of address + photo. Processing 2-12 weeks. **If no exchange**: take the French driving test — theory (code de la route, €30, multiple-choice) plus practical (€600-1,200 for driving school package).",
      },
    ],
    relatedCities: ["paris", "lyon", "marseille", "bordeaux", "toulouse"],
    tags: ["bringing car to france 2026", "car import france expat", "immatriculation france foreigner", "import US car to france", "french driving licence transfer expat"],
  },
  {
    slug: "dental-vision-care-france-expat-guide-2026",
    title: "Dental and Vision Care in France for Expats (2026)",
    metaTitle: "France Dental Vision Care 2026 — expat guide: costs, reimbursement, 100% santé, mutuelle",
    metaDesc: "How dental and vision care work in France for expats in 2026: Assurance Maladie reimbursement, 100% Santé reform, mutuelle, costs of glasses, crowns, implants.",
    category: "lifestyle",
    emoji: "🦷",
    readMinutes: 10,
    publishedAt: "2026-05-25",
    updatedAt: "2026-05-25",
    intro: "France's healthcare reputation is built on its general-medicine and hospital care, but dental and vision care work differently — these are areas where public reimbursement is lower and where a complementary insurance (mutuelle) makes the most economic difference. The 2020 '100% Santé' (Zero Reste à Charge) reform changed the picture significantly: basic dental crowns, hearing aids, and glasses are now fully covered by Sécurité Sociale + mutuelle for in-basket options. For expats, understanding how dental and vision work in France matters because the system is unusually structured and costs vary dramatically based on what tier of care you choose.",
    sections: [
      {
        heading: "How dental and vision differ from general healthcare",
        body: "France's Assurance Maladie covers most general medical care at 70% of regulated tariffs (médecin traitant), with the rest covered by mutuelle. Dental and vision follow a different model: **base reimbursement is much lower** (often 60-70% of artificially low official tariffs), the gap between official tariff and actual price is significant, and the mutuelle plays a much larger role. Without a strong mutuelle, you can have substantial out-of-pocket costs for crowns, implants, glasses, contact lenses, and orthodontics. **The 100% Santé reform (2020-2022)**: introduced standardised baskets ('paniers') of dental, vision, and hearing-aid products that are fully covered by Sécurité Sociale + a standard mutuelle. Dentists, opticians, and hearing-aid providers must offer at least one product from these baskets at zero out-of-pocket cost. Premium products outside the baskets remain partially out of pocket.",
      },
      {
        heading: "Dental care in France: routine and complex procedures",
        body: "**Routine dental visit (consultation)**: €30 official tariff, reimbursed at 70% by Sécu (€21), the remaining €9 covered by mutuelle. Total out-of-pocket: €0. **Cleaning (détartrage)**: €28.92 official tariff, similar reimbursement. **Filling**: €30-50 reimbursed at 70%. **Crown (couronne)**: 100% Santé basket covers a metal-ceramic crown completely (€350-500 cost, all covered). Out-of-basket crowns: €600-1,200, of which Sécu reimburses €107.50, mutuelle covers a portion based on contract, remainder out of pocket. **Dental implant**: NOT covered in 100% Santé basket. Implants cost €1,500-3,500 per tooth; Sécu reimburses approximately €120; mutuelle covers €200-1,500 depending on contract. **Orthodontics**: covered for children under 16 (50% by Sécu + mutuelle reimbursement); not covered for adults except in rare medical-necessity cases. Invisalign or similar for adults: €3,000-6,000 entirely out of pocket. **Finding a dentist**: shortages are real, especially in rural areas and on the Atlantic coast. Doctolib is the standard booking platform. New patient waitlists of 6-12 months are common in tight areas.",
      },
      {
        heading: "Vision care: glasses, contacts, and ophthalmology",
        body: "**Ophthalmologist consultation**: €30-45 official tariff. Reimbursed at 70% by Sécu, balance by mutuelle. Total out-of-pocket: €0 with mutuelle. **Vision check-up frequency**: every 5 years for adults under 42 without complications, every 1-3 years for those with conditions or over 42. **Glasses**: 100% Santé basket includes a frame and lens combination at zero cost — the frame has limited selection (around 50 models, including reasonable ones), the lenses include standard correction and anti-reflective treatment. Premium frames and lenses (designer brands, progressive lenses, anti-blue-light, photochromic) are out-of-basket; cost depends on choice. Typical premium glasses: €200-500 total, of which mutuelle covers €100-400 depending on contract. **Contact lenses**: covered only for specific medical conditions (high prescriptions, certain conditions); usually entirely out of pocket. Annual cost: €200-500 for monthly disposables. **Laser eye surgery (LASIK)**: not covered by Sécu (considered elective). Cost: €1,500-3,000 per eye out of pocket. **Booking ophthalmology**: waitlists of 3-9 months in many cities. Workaround: see an orthoptiste (vision-test specialist) without referral for routine prescriptions — covered by Sécu, faster access, can prescribe glasses.",
      },
      {
        heading: "Choosing the right mutuelle for dental and vision",
        body: "Mutuelles offer 'tiers' or 'levels' of coverage. Basic mutuelles (€20-40/month) cover routine care well but limit dental and vision reimbursement. Mid-tier mutuelles (€40-80/month) typically reimburse up to €300-500/year for dental beyond basket, €200-400/year for premium glasses. High-tier mutuelles (€80-150+/month) cover implants, premium orthodontics, premium frames substantially. **For most expats**: a mid-tier mutuelle is the right call. The cost-benefit of moving to a high-tier mutuelle works only if you specifically anticipate implant work, complex dental, or premium vision in the next 1-2 years. **Major mutuelles**: Harmonie Mutuelle, MGEN (mostly civil servants), Aésio, Mutuelle Générale, MAAF Santé, Apicil. Private/parallel options: Henner, Allianz Santé, Direct Assurance Santé. **Renewal**: since 2020, you can cancel and switch your mutuelle at any time after the first year (Loi de résiliation infra-annuelle). This is genuinely useful — many expats start with their employer's offered mutuelle and switch after 12 months for better value.",
      },
      {
        heading: "What 'gratuit' actually means in 2026 dental and vision",
        body: "The 100% Santé reform created the impression that dental and vision care are 'free' in France. The honest reality: **truly free coverage exists for** in-basket crowns, in-basket bridges, in-basket dentures, in-basket glasses (frame + lenses), and in-basket hearing aids. **You will pay for** dental implants, premium orthodontics, designer frames, premium lens options, premium hearing aids (Bluetooth, etc.), and any private clinic outside the conventionné network. **The system protects against catastrophic dental costs but premium choices remain expensive.** A typical expat household budget for dental and vision in 2026, assuming a good mutuelle: €30-80/month in mutuelle premiums + €100-300/year average out-of-pocket. This is dramatically less than equivalent care in the US (no comparison), the UK (private dental costs are similar to French premium tier), or much of Asia.",
      },
      {
        heading: "Practical tips for expats",
        body: "1. **Register with a dentist and optician early.** Patient acceptance is competitive in many areas. Use Doctolib to identify accepting practices in your area as soon as you arrive. 2. **Use the 100% Santé basket actively.** Many dentists and opticians will quote premium options first — explicitly ask for the 100% Santé option. They are legally required to offer it. 3. **Get full quotes (devis) before treatment.** For any dental work beyond a routine cleaning, the dentist must provide a devis (cost estimate) detailing the official tariff, Sécu reimbursement, and your remaining cost. Always review this and submit to your mutuelle for prior approval if substantial. 4. **Mutuelle 'paniers' vary.** When choosing or switching a mutuelle, focus on the dental and vision sections of the contract — these are where the largest variation exists. The 'forfait optique' (annual maximum reimbursement for glasses) ranges from €100 to €800 depending on contract. 5. **Cross-border dental tourism**: many French residents near the Spanish or Belgian border use cross-border dental work (Spanish prices are 40-60% lower for implants, comparable quality). Hungarian dental tourism is a substantial industry for premium dental work. Your mutuelle may or may not cover foreign care — verify in advance.",
      },
    ],
    relatedCities: ["paris", "lyon", "bordeaux", "marseille", "toulouse"],
    tags: ["dental care france expat 2026", "vision care france expat", "100 sante reform france", "mutuelle dental glasses france", "dental implants france cost"],
  },
  {
    slug: "france-cross-border-workers-expat-guide-2026",
    title: "France for Cross-Border Workers: Switzerland, Germany, Luxembourg, Belgium (2026)",
    metaTitle: "Cross-Border Workers France 2026 — Switzerland Germany Luxembourg Belgium expat guide",
    metaDesc: "Living in France while working in Switzerland, Germany, Luxembourg or Belgium in 2026: taxation, healthcare, transport, the best border cities, costs.",
    category: "remote-work",
    emoji: "🌍",
    readMinutes: 11,
    publishedAt: "2026-05-25",
    updatedAt: "2026-05-25",
    intro: "Cross-border work (travailleur frontalier) is a long-standing French phenomenon — roughly 230,000 people live in France and work in Switzerland, 50,000 work in Luxembourg, 45,000 in Germany, 15,000 in Belgium, plus smaller numbers in Monaco, Spain, and Italy. The economic logic is consistent: high salaries from a higher-cost neighbour, lower living costs by living in France, but bilateral tax and social-security treaties that require careful navigation. For expats considering this lifestyle, the choice of border city matters enormously — not all French border towns are equal in transport, infrastructure, and quality of life. Here is the complete 2026 picture for the four major corridors.",
    sections: [
      {
        heading: "France-Switzerland: the largest and most lucrative corridor",
        body: "Approximately 230,000 frontaliers, primarily working in Geneva and Basel cantons. Geneva pays Swiss salaries (median ~CHF 100,000 / €106,000 for skilled professionals); French border living costs are 40-60% lower. **Border French cities**: Annecy (1h commute to Geneva — high quality of life, Lake Annecy, Pays de Gex employer base nearby), Saint-Julien-en-Genevois (15 min to Geneva — convenient but limited infrastructure), Annemasse (10 min from Geneva — affordable, growing), Bellegarde-sur-Valserine (35 min by train — cheaper than coast options), Thonon-les-Bains (lakeside, 30-50 min to Geneva by boat or car). For Basel corridor: Saint-Louis (10 min to Basel — affordable, less developed), Mulhouse (45 min to Basel — major French city with full infrastructure). **Tax and social security**: complex. Two main regimes: 1) **Taxed in Switzerland, declare in France** — if you live in France but work in Geneva, Basel, or specific cantons listed in the bilateral treaty, your income is taxed in Switzerland (cantonal + federal). You declare in France for information; France applies the 'crédit d'impôt' to prevent double tax. 2) **Other cantons** (Zürich, Vaud outside specific zones): taxed in France instead. Verify your specific situation. Healthcare: cross-border workers can opt for French Assurance Maladie or Swiss LAMal (this choice was renegotiated in 2014 — most stay with French Sécu, cheaper for families). **Salaries net of French tax**: still significantly higher than equivalent French roles (typically 30-60% higher net income for the same profession).",
      },
      {
        heading: "France-Luxembourg: high salaries, smaller scale",
        body: "Approximately 50,000 frontaliers, primarily from Lorraine (Metz, Thionville, Longwy region) working in Luxembourg City and the south industrial belt. Luxembourg salaries are 30-50% above French equivalents; French border housing is 40-50% cheaper than Luxembourg. **Border French cities**: Thionville (Moselle — 30 min to Luxembourg City by train, the dominant frontalier town, good infrastructure), Longwy (Meurthe-et-Moselle — 30 min by train, industrial heritage, more affordable), Metz (1h to Luxembourg City by train — full French city services, larger scale). **Tax and social security**: simpler than Switzerland. Frontaliers earning at least 50% of their salary in Luxembourg are taxed in Luxembourg with the bilateral treaty preventing double tax. Healthcare: Luxembourg CNS for the worker, French Sécu for the family. Pension: contributions accumulated in Luxembourg's system, which is generous. **Bonus**: Luxembourg has the highest minimum wage in the EU (€2,650/month gross in 2026), so even entry-level cross-border roles are well-paid. **Drawback**: traffic congestion between Lorraine and Luxembourg has worsened significantly — the A31 motorway is one of France's most congested daily corridors. Many use the train (TER Express Metz-Thionville-Bettembourg-Luxembourg, every 15-30 min during rush hours).",
      },
      {
        heading: "France-Germany: the Alsace corridor",
        body: "Approximately 45,000 frontaliers, primarily working in Karlsruhe, Freiburg, and the Rhineland industrial belt. German salaries in the area are 15-25% above French equivalents. **Border French cities**: Strasbourg (major French city with tram link to Kehl, full services), Saint-Louis (10 min to Basel — but also serves Lörrach in Germany), Wissembourg (40 min to Karlsruhe), Sarreguemines (45 min to Saarbrücken). **Tax and social security**: relatively simple. Cross-border workers in the 30-km bilateral zone are taxed in France with the salary subject to French income tax. Healthcare: contributions go to German social security; French Sécu can also apply with formal opt-in. Many German employers offer Germany-based pension supplements. **Linguistic note**: Alsatian (Alsacien) and German are widely spoken on both sides of the border in the rural communities. Many frontaliers grew up in bilingual households and treat the border as an administrative line rather than a cultural one. Salaries in this corridor are less differentiated from French than the Swiss or Luxembourg corridors — many do it for the type of job (often German-speaking specialisations) rather than just salary arbitrage.",
      },
      {
        heading: "France-Belgium: the Nord corridor",
        body: "Approximately 15,000 frontaliers, primarily in the Nord département working in Mouscron, Tournai, and Charleroi. Belgian salaries are similar to French — this corridor is less about salary arbitrage and more about specific job markets (some sectors are stronger in Belgium, especially Flemish-speaking industries). **Border French cities**: Lille (major French city, 30 min to Mouscron by car, 1h to Brussels by train), Tourcoing (15 min to Mouscron — small French town), Maubeuge (35 min to Charleroi). **Tax and social security**: bilateral treaty similar to other neighbours, generally tax in country of work with credit in country of residence. **The Lille metropolitan area** has the most developed cross-border infrastructure with Tournai and Kortrijk (Belgium) — buses and trains are integrated, the cultural and commercial lives are genuinely intermingled. **Salaries**: less differentiated from France; this corridor is more about specific industries (Wallonia's industrial belt, Flemish companies needing French-language professionals) than systematic salary arbitrage.",
      },
      {
        heading: "Practical considerations for cross-border living",
        body: "1. **Commute reality**: 'Geneva 30 minutes from Annemasse' is true at 10pm on a Sunday. Monday 8am, expect 60-90 min. Verify commute times at your actual planned departure times. The A40 (Mont Blanc tunnel approach), A31 (Lorraine to Luxembourg), and certain border crossings are among France's most congested roads. Train is usually more reliable but rush-hour capacity fills. 2. **Schedule and work patterns**: many frontaliers do 4 long days in office + 1 remote day from home in France — increasingly common since 2021. Switzerland, Luxembourg, and Germany all have some remote-work flexibility, but most positions still require physical presence. 3. **Schooling**: bilingual French/German (Alsace), French/English (Geneva area increasingly), French/Italian (Annecy region) are real options. School holidays differ between countries — frontaliers with families must plan around two school calendars. 4. **Insurance considerations**: car insurance must cover frequent border crossings (most French policies do, verify your specific contract); home insurance is purely French. **5. Banking**: many cross-border workers maintain accounts in both countries — French current account + Swiss bank/Luxembourg bank for salary deposit. Currency conversion fees can be significant; use online services (Wise, Revolut) to mitigate.",
      },
      {
        heading: "Verdict: who cross-border living works for and where",
        body: "Cross-border work in 2026 is genuinely lucrative for the Swiss and Luxembourg corridors — net household income gains of 30-50% versus equivalent fully-French roles are realistic. It works less well for the German and Belgian corridors as a salary play; those are more about specific career paths. **Best French border cities for living**: Annecy (Switzerland) — combines stunning lifestyle with cross-border income, expensive property but the most attractive overall. **Thionville/Metz (Luxembourg)** — solid French infrastructure, manageable commute, good schools. **Strasbourg (Germany)** — major French city, tramway to Germany, cultural depth. **Lille (Belgium)** — major French metropolitan area, lower income gap but full city services. **For expats specifically**: Annecy is a strong cross-border location with international community; Geneva is the international hub on the Swiss side, accessible easily; Luxembourg City has the EU's most international professional community. **Practical advice**: take a 6-12 month rental before purchasing property — the commute realities and lifestyle effects of cross-border living are not always what they look like on paper.",
      },
    ],
    relatedCities: ["annecy", "annemasse", "strasbourg", "metz", "thionville", "lille"],
    tags: ["frontalier france 2026", "france switzerland cross border worker", "france luxembourg frontalier", "best french border cities", "cross border worker france expat"],
  },
  {
    slug: "aix-en-provence-vs-marseille-expat-comparison-2026",
    title: "Aix-en-Provence vs Marseille: Which for Expats? (2026)",
    metaTitle: "Aix vs Marseille 2026 — expat city comparison, cost of living, neighbourhoods, lifestyle",
    metaDesc: "Aix-en-Provence or Marseille for expats in 2026? Compared by cost of living, neighbourhoods, safety, schools, expat community, climate, and lifestyle.",
    category: "city-guide",
    emoji: "🌞",
    readMinutes: 10,
    publishedAt: "2026-05-25",
    updatedAt: "2026-05-25",
    intro: "Aix-en-Provence and Marseille are 32 km apart but feel like different countries. Aix is the elegant Provençal university town — fountains, plane trees, 18th-century mansions, students and tourists. Marseille is France's port city — chaotic, multicultural, working-class roots, urban scale, Mediterranean energy. Both have devoted expat communities and each defends its choice fiercely. This guide compares them head to head for an expat trying to decide.",
    sections: [
      {
        heading: "Geographic and demographic basics",
        body: "**Marseille**: 873,000 in the city, 1.6 million metropolitan area. France's 2nd largest city, founded ~600 BCE, the largest Mediterranean port. 16 administrative arrondissements. **Aix-en-Provence**: 144,000 in the city, 410,000 metropolitan area (the Pays d'Aix). Founded by Romans, university town since 1409 (the university is one of Europe's oldest), home to ~40,000 students. Climate: both have Mediterranean climate, hot dry summers (peak 32-36°C, occasional heatwaves to 40°C), mild winters (peak 13-15°C, lows rarely below 5°C). Aix is slightly cooler in summer (the city sits at 173m altitude, vs. Marseille at sea level — meaningful for summer evenings). Annual rainfall similar, ~550mm.",
      },
      {
        heading: "Cost of living: Aix is significantly more expensive",
        body: "**Aix-en-Provence**: rental T2 furnished €750-1,050/month centrally, T3 €1,050-1,500/month. Buying: €4,500-7,500/m² ancien, €5,000-8,000 neuf. **Marseille**: rental T2 €550-950/month centrally (varies enormously by arrondissement), T3 €750-1,250/month. Buying: €2,500-5,500/m² ancien in good neighbourhoods, €3,500-6,500 in premium zones. Marseille is roughly 25-40% cheaper depending on neighbourhood. Groceries: similar national average, both have excellent local markets (Aix has Marché des Prêcheurs/Place Richelme; Marseille has Noailles, Castellane). Restaurants: Aix is more expensive per meal (boutique, gentrified scene), Marseille has wider price variety (cheap eats to fine dining). Public transport: Aix has limited bus network only; Marseille has metro (2 lines), tram (3 lines), bus — but Marseille's transit is unreliable by French standards.",
      },
      {
        heading: "Neighbourhood comparison",
        body: "**Aix-en-Provence**: **Centre historique** — beautiful pedestrianised streets, fountains, the most desirable but very expensive. T2 €900-1,100/month. **Mazarin** — elegant 17th-century district, the bourgeois centre, family residences. T3 €1,200-1,500/month. **Sextius-Mirabeau** — modern redeveloped area near Cours Mirabeau, mid-range. **Pont de l'Arc** — pleasant residential, family-oriented. **Outer Aix (Luynes, Puyricard)** — village character within commuting distance, larger properties, more affordable. **Marseille**: **6th arrondissement (Castellane, Préfecture)** — bourgeois centre, schools, good. **7th arrondissement (Endoume, Catalans, Bompard)** — sea-facing, most beautiful, expensive. **8th (Périer, Roucas-Blanc)** — quieter wealthy. **5th (La Plaine, Cours Julien, Cinq-Avenues)** — vibrant, artistic, more affordable. **1st (Noailles, Belsunce)** — diverse, dense, low-cost but rough. **13th-16th (Northern arrondissements)** — concentrated social housing, higher crime, avoid for first-time expat housing search.",
      },
      {
        heading: "Safety comparison",
        body: "This is the most asked question, so honest answer: **Aix-en-Provence** has crime statistics significantly below the French urban average — petty theft and bag-snatching exist (especially during tourist season) but violent crime is rare. As a student town with significant patrol presence, daily safety is excellent. **Marseille** has well-known crime issues concentrated in specific northern arrondissements (3rd, 14th, 15th, 16th), driven primarily by drug-trafficking networks. The 6th, 7th, 8th, and most of the 5th arrondissements have crime rates comparable to other major French cities (around or below Lyon). **The honest framing**: an expat living in Aix-en-Provence has lower daily crime exposure than one living in Marseille 6th. The Marseille average statistic includes the northern arrondissements where most expats would not live anyway. Choose your neighbourhood carefully in Marseille and the gap closes substantially.",
      },
      {
        heading: "Expat community and integration",
        body: "**Aix-en-Provence**: substantial expat community, particularly American (Aix has long had Americans associated with the AIX/CEFAM/SciencesPo branch and tourism), British (Provence has the longest-standing British expat presence in France), and increasingly Dutch and German remote workers. The community feels coherent — language exchange groups, expat meetups, English-speaking churches and clubs. Aix's manageable size (you will run into the same people) accelerates integration. **Marseille**: smaller proportional expat community but more diverse — more Italian, Spanish, Algerian, Senegalese, and other Mediterranean-origin populations. The city's scale means expats coexist in different milieus rather than forming a unified community. Marseille feels more authentic to its character; Aix feels more international. For different expats this is a feature or a bug.",
      },
      {
        heading: "Daily life: practical differences",
        body: "**Aix's day-to-day**: walkable city, easy to do errands on foot, café culture, university energy in term, refined Provençal cuisine, weekend market access to the lavender fields and the Cézanne countryside. The downside: small scale can feel claustrophobic over years; everyone knows your business; nightlife is modest (a few late-night bars, two clubs); the city empties in August. **Marseille's day-to-day**: scale and variety — multiple distinct neighbourhoods, beach access from urban core, Calanques National Park starts at the city edge, full international airport (MRS, Marseille-Provence, 25 min from centre), substantial cultural and sporting scene (Olympique de Marseille, opera, multiple museums), proper restaurant variety from couscous to bouillabaisse. Marseille feels alive in a way that Aix doesn't quite. The downside: traffic is real; public transport is unreliable; you need a car for many practical errands; the visual environment is rougher.",
      },
      {
        heading: "Schools and family infrastructure",
        body: "**Aix-en-Provence**: public schools are good. The international school landscape is strong — Lycée International de Provence (Marseille area, French Baccalauréat International), International Bilingual School of Provence (IBS, an independent international school), American School Lou Mistralou. Family infrastructure (parks, paediatrics, childcare) is generous for the city's scale. **Marseille**: public schools vary enormously by neighbourhood — schools in the 6th, 7th, 8th are good; some northern schools struggle. International options: Lycée International de Provence (close), American School (Aix area), Marseille's own bilingual sections (some good). For families, Aix tends to be the easier choice — schools concentrated in a smaller geographic area, more parental community.",
      },
      {
        heading: "Verdict",
        body: "**Choose Aix-en-Provence** if: you prioritise beauty, walkability, and small-city polish over urban energy; you have school-age children and want easy access to international schools; you want a strong expat community with a sense of fitting in; you can afford the premium pricing (Aix is one of France's most expensive cities per m²); you prefer Provence's countryside over urban density. **Choose Marseille** if: you want urban scale, energy, and diversity; you appreciate Marseille's authentic Mediterranean culture; you value sea and Calanques access from your daily life; you want a wider professional network and job market; budget is a significant constraint (Marseille gives more space per euro); you embrace urban roughness as a feature, not a bug. **The honest summary**: Aix-en-Provence works for couples and families seeking refined provincial life; Marseille works for individuals and couples seeking real urban life. Both deliver something the other cannot.",
      },
    ],
