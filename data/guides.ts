...
export const GUIDES: Guide[] = [
  ...
  {
    slug: "vivre-en-corse-guide-2026",
    title: "Vivre en Corse en 2026 : Ajaccio, Bastia, Porto-Vecchio, Corte — le guide complet",
    metaTitle: "Vivre en Corse 2026 — Ajaccio, Bastia, Corte : guide honnête | MeilleurVille",
    metaDesc:
      "Logement, coût de la vie, emploi, santé, quotidien : notre guide complet et honnête pour s'installer en Corse en 2026. Ajaccio, Bastia, Porto-Vecchio, Corte — ce que les brochures ne disent pas.",
    category: "region",
    emoji: "🏝️",
    readMinutes: 13,
    ...
    sections: [
      {
        ...
        body: "La Corse est une collectivité territoriale unique depuis 2018 (Collectivité de Corse, loi du 7 août 2015 applicable au 1er janvier 2018), dotée d'une assemblée et d'un exécutif propres. Cette autonomie administrative se traduit par des politiques spécifiques en matière de logement, de transport et d'aménagement. Deux réalités coexistent : la Corse côtière — Ajaccio, Bastia, Porto-Vecchio, Calvi — où se concentrent l'emploi, les services et la pression immobilière, et la Corse intérieure — Corte, les villages de montagne, la Castagniccia — où la vie est moins chère mais les services beaucoup moins denses. Pour le nouvel arrivant, la première question n'est pas « Corse ou pas Corse ? » mais « Quel type de vie en Corse ? ». Le réseau de transport interne est limité : deux lignes de chemin de fer à voie métrique (Chemins de Fer de la Corse, CFC) relient Ajaccio à Bastia via Corte, et Calvi à l'Île-Rousse. Sans voiture, la mobilité reste difficile hors zones urbaines. La continuité territoriale (aides aux transports aériens et maritimes accordées aux résidents corses) est un avantage financier réel : les résidents bénéficient de tarifs réduits sur les ferries Marseille–Ajaccio et Nice–Bastia (Office des Transports de la Corse, dotation 2025 : 187 millions d'euros).",
      },
      {
      ...
      },
      {
        ...
        body: "La « surcoût insulaire » (sur-coût lié à l'éloignement et aux coûts de transport des matériaux) s'applique à tous les secteurs économiques en Corse, et le logement ne fait pas exception. La construction est plus chère (environ +20 % par rapport à la France continentale, selon la Fédération Française du Bâtiment – délégation Corse, rapport 2024), ce qui maintient les prix d'achat et les loyers durablement au-dessus de ce que le marché du travail local justifierait. Prix médian d'achat au m² (2025, source Notaires de Corse) : Ajaccio 3 600–4 400 €/m², Bastia 2 800–3 500 €/m², Porto-Vecchio 4 500–7 000 €/m² (selon proximité mer), Corte 1 800–2 400 €/m². Côté locatif, le marché souffre d'un phénomène de saisonnalisation : les propriétaires préfèrent souvent louer en saisonnier pour 4–5 mois à des tarifs 3 à 4 fois supérieurs. La loi portant sur l'encadrement des meublés touristiques (article 145 de la loi Habitat dégradé, 2023) a amorcé des correctifs, mais l'effet reste limité en Corse. Conseil pratique : chercher via les réseaux locaux (groupes Facebook « Location annuelle Corse », agences locales), les plateformes nationales proposent peu d'offres à l'année. Les quartiers à loyer maîtrisé existent — mais nécessitent une connaissance du terrain que les outils en ligne n'offrent pas.",
      },
      {
        heading: "Emploi, santé, services : ce que les brochures ne disent pas",
        body: "Emploi : le taux de chômage en Corse est structurellement supérieur à la moyenne nationale — 9,3 % au T3 2025 (INSEE, toutes zones confondues), contre 7,4 % en métropole. Les secteurs qui recrutent à l'année : collectivité territoriale et fonctions publiques (20 % de l'emploi total), santé et médico-social (CHU d'Ajaccio, Hôpital Falconaja à Bastia), éducation nationale, BTP, hôtellerie-restauration (mais saisonnier). Le télétravail change la donne : un actif avec un emploi à distance peut vivre en Corse avec un salaire continental — la combinaison la plus viable pour qui cherche à s'installer sans chercher d'emploi local. Santé : l'ARS Corse classe la région en tension pour les médecins généralistes et spécialistes. Ajaccio et Bastia disposent d'hôpitaux complets, mais certaines spécialités (neurologues, rhumatologues) nécessitent des déplacements à Marseille ou Nice. L'accès à des soins non urgents peut prendre plusieurs semaines. Ce point est critique pour les familles avec enfants ou les personnes ayant des besoins médicaux réguliers. École : les écoles publiques couvrent bien les zones urbaines ; en zone rurale, les regroupements pédagogiques concentrés (RPC) existent mais allongent les trajets. L'enseignement de la langue corse est obligatoire dans les écoles primaires depuis 2013.",
      },
      {
        heading: "Le verdict : pour qui est vraiment fait de vivre en Corse ?",
        body: "La Corse n'est pas une destination universelle. Elle offre quelque chose d'unique — une qualité de vie sensorielle et environnementale que peu de régions françaises peuvent égaler, une identité culturelle forte, une relation à la nature et au temps qui tranche avec le rythme continental. Mais elle exige des compromis que tout candidat doit évaluer lucidement. Elle convient bien à : les télétravailleurs avec emploi sécurisé à distance, cherchant qualité de vie, nature et soleil ; les retraités disposant d'un revenu garanti (pension, rentes) et n'ayant pas besoin d'un bassin d'emploi local ; les profils autonomes et débrouillards, capables de gérer l'isolement hivernal et les aléas logistiques insulaires ; les passionnés de montagne, de mer, de randonnée, de planche à voile. Elle est déconseillée à : les chercheurs d'emploi en reconversion professionnelle sans réseau local (le marché du travail est insuffisant pour absorber une demande non-qualifiée sur l'île) ; les familles avec enfants ayant des besoins médicaux spécifiques ou des exigences scolaires élevées dans des filières spécialisées ; les personnes ne supportant pas l'enclavement estival (saturation des routes, délais de livraison, tensions de ressources). Résumé pour les données clés 2026 : ensoleillement Ajaccio 2 820 h/an (Météo-France), loyer T2 médian 620–950 €/mois selon ville (ADIL Corse), chômage régional 9,3 % (INSEE T3 2025), prix achat médian 1 800–7 000 €/m² selon localisation (Notaires de Corse 2025).",
      },
    ],
    relatedCities: ["ajaccio", "bastia", "porto-vecchio", "corte"],
    relatedGuides: [
      "vivre-bord-mer-france-guide",
      "retraite-france-guide",
      "meilleures-villes-pour-retraite-france-2025",
    ...
    tags: ["Corse", "Ajaccio", "Bastia", "Porto-Vecchio", "Corte", "insularité", "télétravail", "retraite", "logement", "coût de la vie"],
  },
  {
    slug: "vivre-en-lorraine-metz-nancy-thionville-2026",
    title: "Vivre en Lorraine en 2026 : Metz, Nancy, Thionville, Épinal — le guide complet",
    metaTitle: "Vivre en Lorraine 2026 — Metz, Nancy, Thionville : guide honnête | MeilleurVille",
    metaDesc:
      "Logement abordable, avantage frontalier Luxembourg, culture et patrimoine exceptionnel : notre guide 2026 pour s'installer en Lorraine. Metz, Nancy, Thionville, Épinal — ce que les guides touristiques omettent.",
    category: "region",
    emoji: "⚜️",
    readMinutes: 12,
    ...
    sections: [
      {
        heading: "La Lorraine en 2026 : comprendre le territoire avant de s'y installer",
        body: "La Lorraine n'est plus une région administrative autonome depuis le 1er janvier 2016 : elle fait partie du Grand Est aux côtés de l'Alsace et de la Champagne-Ardenne (loi NOTRe, 2015). Mais l'identité lorraine reste très présente — dans les cultures locales, dans les réseaux professionnels, et surtout dans le poids économique que représente la frontière luxembourgeoise. Géographiquement, la zone couvre 23 547 km² et compte 2,3 millions d'habitants (INSEE 2021), répartis principalement autour de deux pôles urbains : Metz (métropole Metz Métropole, 390 000 habitants dans l'aire urbaine) et Nancy (métropole Grand Nancy, 430 000 habitants dans l'aire urbaine). Ce que peu de guides soulignent : la Lorraine est l'une des régions les plus inégales de France en termes de dynamisme. Le sillon mosellan (Metz–Thionville–Forbach) est en pleine mutation positive, porté par le débordement économique du Luxembourg. En revanche, les Vosges et la Meuse restent confrontées à une déprise démographique structurelle — deux territoires à enjeux différents. Premier réflexe à avoir avant de s'installer : identifier de quel « bassin lorrain » vous parlez, car les réalités de Thionville et d'Épinal n'ont quasiment rien en commun.",
      },
      {
      ...
      },
      {
        ...
        body: "La Lorraine figure parmi les régions les plus accessibles de France pour l'immobilier — un avantage structurel qui reflète aussi un marché du travail moins sous pression que Paris, Lyon ou Bordeaux. Loyers médians T2 par ville (ADIL Moselle / Meurthe-et-Moselle / Vosges, T4 2025) : Thionville 640–800 €, Metz 580–720 €, Nancy 540–680 €, Épinal 440–570 €. À titre de comparaison : un T2 médian à Lyon se loue 750–950 €, à Bordeaux 700–900 €. Prix d'achat médian (Notaires Grand Est, 2025) : Thionville 2 400–3 200 €/m², Metz 1 600–2 800 €/m², Nancy 1 900–2 600 €/m², Épinal 1 200–1 700 €/m². La copropriété ancienne à Metz et Nancy offre des opportunités réelles pour primo-accédants : un T3 de 65–75 m² en centre-ville se négocie entre 130 000 et 180 000 €. Particularité vosgienne : les maisons individuelles sur le piémont vosgien (autour de Gérardmer, La Bresse, Remiremont) se vendent à des prix qui ont sensiblement progressé depuis 2020 (+18 % en cinq ans, Notaires des Vosges), sous l'effet de la demande parisienne de résidences secondaires et de télétravail. Conseil pratique : les quartiers en QPV (Quartiers Prioritaires de la politique de la Ville) à Nancy et Metz proposent des loyers très bas, mais nécessitent une bonne connaissance du tissu local avant d'engager une location ou un achat.",
      },
      {
        heading: "Qualité de vie, culture et sécurité : ce que les chiffres montrent",
        body: "Culture : Metz et Nancy disposent d'une offre culturelle remarquable pour des villes de leur taille. Le Centre Pompidou-Metz (350 000 visiteurs/an, CMP 2025) est une institution nationale délocalisée unique. Nancy possède l'Opéra National de Lorraine, le Musée des Beaux-Arts (collection XIVe–XXIe siècle), et le Musée de l'École de Nancy — foyer du mouvement Art Nouveau aux côtés de Guimard et Gallé. Les festivals : Nancy Jazz Pulsations (octobre, 100 000 spectateurs), la Mirabelle d'Or (Metz, septembre), le Festival du Livre de Nancy (printemps). Qualité de l'air : ATMO Grand Est classe Metz et Nancy en indice moyen 2–3/5 (bon à modéré, 2025) — nettement meilleur que la moyenne des agglomérations industrielles françaises. Sécurité : selon les données SSMSI (Ministère de l'Intérieur, 2024), Metz présente un taux de crimes et délits de 72 pour 1 000 habitants, Nancy 68 pour 1 000 — au-dessus de la moyenne nationale (58 pour 1 000) mais comparable à des villes comme Montpellier ou Toulon. Ces chiffres sont fortement concentrés géographiquement : les secteurs QPV représentent l'essentiel des incidents, tandis que les quartiers résidentiels présentent des indicateurs proches des villes les plus sûres. Transports : le réseau Mettis (TCRM) à Metz dispose de deux lignes de bus à haut niveau de service ; Nancy opère le réseau Filéo et Stan (bus + tramway). Le TER Grand Est relie Metz–Nancy en 35 minutes (14 liaisons quotidiennes, SNCF 2025), permettant de résider dans l'une et travailler dans l'autre.",
      },
      {
        heading: "Le verdict : pour qui est vraiment fait de vivre en Lorraine ?",
        body: "La Lorraine de 2026 offre une combinaison rarement égalée ailleurs en France : accessibilité immobilière réelle, richesse culturelle et patrimoniale exceptionnelle, connexions TGV vers Paris et proximité du marché du travail luxembourgeois. Mais elle exige de choisir son bassin avec lucidité. Elle convient bien à : les frontaliers luxembourgeois cherchant à maximiser leur pouvoir d'achat immobilier tout en conservant un environnement urbain français — Thionville et le sillon mosellan sont la réponse évidente ; les étudiants et jeunes actifs attirés par un coût de la vie parmi les plus bas des grandes villes universitaires françaises — Nancy en particulier offre un rapport coût/qualité de vie exceptionnel avec 60 000 étudiants et une place Stanislas comme campus de fait ; les familles qui valorisent la sécurité des quartiers résidentiels, les écoles publiques performantes et un budget logement maîtrisé — Metz et Nancy répondent aux deux critères dans leurs secteurs résidentiels établis ; les télétravailleurs cherchant une base peu chère avec accès TGV à Paris — un T2 à Nancy à 600 €/mois avec Paris à 1h30, c'est une des meilleures équations de France ; les retraités actifs appréciant le patrimoine, les musées, les balades en Vosges et un coût de la vie modéré — Épinal et ses environs offrent une douceur de vivre discrète. Elle est déconseillée à : ceux qui cherchent un marché de l'emploi local très dynamique hors secteurs public, santé et logistique — Lorraine reste en retrait sur la création d'emplois privés face à Lyon, Bordeaux ou Toulouse ; ceux qui ont besoin de soleil structurel — le climat continental lorrain impose des hivers froids et gris (Metz : 1 750 heures de soleil/an, Météo-France, vs 2 800 à Nice) ; ceux qui s'installent dans les Vosges rurales sans emploi sécurisé à distance — le bassin d'emploi d'Épinal ne peut absorber une demande non-qualifiée. Synthèse chiffres-clés 2026 : loyer T2 médian Nancy 540–680 €/mois (ADIL), prix achat médian Metz 1 600–2 800 €/m² (Notaires), TGV Paris–Nancy 1h30 (SNCF), frontaliers France–Luxembourg 115 000 (IGSS 2025).",
      },
    ],
