...
const RAW_CITIES_SEED = [
  ...
  },
  {
    ...
    avgTempJuly: 24.5,
    avgTempJanuary: 4.0,
    characterTags: ["Seine-et-Marne", "Île-de-France", "Marne", "TGV", "cathédrale", "brie", "accessible Paris"],
    scores: {
      global: 6.5,
      life: 6.5,
      transport: 8.0,
  ...
  },
  {
    ...
    avgTempJuly: 23.5,
    avgTempJanuary: 4.0,
    characterTags: ["Yvelines", "Île-de-France", "château", "forêt domaniale", "bord de Paris", "RER C", "résidentiel"],
    scores: {
      global: 7.5,
      life: 7.5,
      transport: 7.5,
