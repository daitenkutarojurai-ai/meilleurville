...
import { assertUniqueInseeCodes, assertUniqueSlugs } from "@/lib/data-integrity";
...
const RAW_CITIES_SEED = [
  ...
  },
  {
    ...
    region: "Nouvelle-Aquitaine",
    department: "Charente-Maritime",
    // L'île compte 10 communes et n'a pas de code propre. On l'ancre sur
    // Saint-Martin-de-Ré, son chef-lieu historique, plutôt que sur La Rochelle
    // (17300, continent) qu'elle portait par erreur : les données rattachées
    // sont ainsi au moins sur l'île. Les agrégats à l'échelle de l'île
    // n'existent pas dans les sources communales.
    inseeCode: "17369",
    population: 18000,
    latitude: 46.2000,
    longitude: -1.4000,
  ...
  },
  {
    ...
    region: "Île-de-France",
    department: "Seine-Saint-Denis",
    // Code historique : Pierrefitte-sur-Seine a fusionné dans Saint-Denis
    // (93066) le 1er janvier 2025. On garde la ville et son ancien code — les
    // jeux de données en géographie 2025+ ne la contiennent donc plus (pas de
    // revenu Filosofi, pas de parcs OSM sur ce ref:INSEE), et c'est normal.
    inseeCode: "93059",
    population: 30200,
    latitude: 48.9622,
    longitude: 2.3597,
...
assertUniqueSlugs({ slugs: CITIES_SEED.map((c) => c.slug), contextLabel: "cities-seed.slug" });
assertUniqueInseeCodes({ cities: CITIES_SEED, contextLabel: "cities-seed.inseeCode" });
