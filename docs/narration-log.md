...
Prochains plus atteints, mesurés (~~`-royan-`~~ traité le 09/09, ~~`-pezenas-`~~ le 11/09) :
`-montbeliard-` (1/35), `-sisteron-` (1/36), `-concarneau-` (1/36),
...
- 2026-09-11 data/guides.ts :: 10-choses-a-faire-a-pezenas-2026 (1/34 → 0 cadratin, 724 → 904 mots ; guide le plus atteint de la queue mesurée le 05/09, mise en prose complète)
- 2026-09-16 data/guides.ts :: 10-choses-a-faire-a-montbeliard-2026 (1/35 → 0 cadratin, 773 → 1016 mots ; guide le plus atteint du corpus au comptage de ce run, mise en prose complète). ⚠️ **Erreur de fait laissée en place, section 4, à traiter hors de cette routine** : « Vincent Van Gogh y a peint "La Source de la Loue", son ultime toile en 1890 ». Le tableau est de **Gustave Courbet, 1864** (Albright-Knox, Buffalo), natif d'Ornans à quelques kilomètres de la source ; il en a peint plus de dix toiles. Van Gogh n'a jamais peint la Loue et ses dernières toiles sont à Auvers-sur-Oise. Vérifié en ligne ce run. Non corrigé parce que l'agent narration ne touche pas aux faits et que son garde-fou interdit qu'un nombre change — **la correction demande un run de contenu**. Occurrence unique dans le corpus : la jumelle EN `things-to-do-in-montbeliard-2026` existe mais ne mentionne ni la Loue ni Van Gogh, donc rien à corriger de ce côté.
